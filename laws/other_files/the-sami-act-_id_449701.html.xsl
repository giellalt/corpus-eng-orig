...
<xsl:variable name="filename" select="'http://regjeringen.no/en/doc/Laws/Acts/the-sami-act-.html?id=449701'"/>
...
<xsl:variable name="para_nob" select="'hl-19870612-056.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="1987-06-12-56.html" xml:lang="nob"/>
