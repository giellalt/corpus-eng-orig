...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://helsenorge.no/coronavirus/high-risk-groups?redirect=false'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'High risk groups and their relatives'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="risikogrupper_for_koronaviruset_og_deres_parorende.html"/>
