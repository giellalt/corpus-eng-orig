...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=registration&amp;task=register&amp;lang=english'"/>
...
<xsl:variable name="para_fin" select="'index.php_option=registration_task=register_lang=finnish.html'"/>
