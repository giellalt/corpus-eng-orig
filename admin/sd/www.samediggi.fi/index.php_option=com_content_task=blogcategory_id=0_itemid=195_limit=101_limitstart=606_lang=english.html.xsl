...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=blogcategory&amp;id=0&amp;Itemid=195&amp;limit=101&amp;limitstart=606&amp;lang=english'"/>
...
<xsl:variable name="para_fin" select="'index.php_option=com_content_task=blogcategory_id=0_itemid=195_limit=101_limitstart=606_lang=finnish.html'"/>
