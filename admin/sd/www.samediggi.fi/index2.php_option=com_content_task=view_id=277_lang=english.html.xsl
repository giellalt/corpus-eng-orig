...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index2.php?option=com_content&amp;task=view&amp;id=277&amp;lang=english'"/>
...
<parallel_text location="index2.php_option=com_content_task=view_id=277_lang=finnish.html" xml:lang="fin"/>
</xsl:variable>
