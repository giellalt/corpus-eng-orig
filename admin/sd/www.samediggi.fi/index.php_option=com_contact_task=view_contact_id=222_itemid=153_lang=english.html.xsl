...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_contact&amp;task=view&amp;contact_id=222&amp;Itemid=153&amp;lang=english'"/>
...
<xsl:variable name="para_fin" select="'index.php_option=com_contact_task=view_contact_id=222_itemid=153_lang=finnish.html'"/>
