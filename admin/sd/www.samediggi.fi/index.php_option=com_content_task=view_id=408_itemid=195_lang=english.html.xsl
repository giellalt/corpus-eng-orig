...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=408&amp;Itemid=195&amp;lang=english'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=view_id=408_itemid=195_lang=finnish.html" xml:lang="fin"/>
