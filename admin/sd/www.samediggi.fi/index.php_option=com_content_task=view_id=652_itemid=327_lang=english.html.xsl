...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=652&amp;Itemid=327&amp;lang=english'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_option=com_content_task=view_id=652_itemid=327_lang=finnish.html" xml:lang="fin"/>
