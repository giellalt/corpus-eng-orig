...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/content/download/2025/19253/version/1/file/Final+Draft+Inari+Declaration+120612+Rev+2+%283%29.pdf'"/>
    ...
    <parallel_text xml:lang="fin" location="inarin_julkilausuma_ykn_alkupera_iskansojen_konferenssista_-_julistus_suomeksi_darkkistan.pdf"/>
