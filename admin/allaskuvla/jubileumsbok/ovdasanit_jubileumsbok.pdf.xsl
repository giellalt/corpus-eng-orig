...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samas.no/sites/default/files/jubileumsbok_sa_20_jagi_nett.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sámi oahpahus – sámi dutkan – sámi ásahus Sámi allaskuvla 20 jagi'"/>
    <!--
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Kristine'"/>
    <xsl:variable name="author2_ln" select="'Nystad'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author3_fn" select="'Torunn'"/>
    <xsl:variable name="author3_ln" select="'Pettersen'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="ovdasanit_jubileumsbok.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'2-7, 10-153'"/>
