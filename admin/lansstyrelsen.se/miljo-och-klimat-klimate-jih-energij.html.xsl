...
<xsl:variable name="filename" select="'http://www.lansstyrelsen.se/dalarna/En/miljo-och-klimat/klimat-och-energi/Pages/default.aspx'"/>
...
<xsl:variable name="parallels">
  ...
  <!-- <parallel_text xml:lang="swe" location=""/> -->
	<parallel_text xml:lang="sma" location="miljo-och-klimat-klimate-jih-energij.html"/>
	<parallel_text xml:lang="swe" location="miljo-och-klimat-klimate-jih-energij.html"/>
</xsl:variable>
