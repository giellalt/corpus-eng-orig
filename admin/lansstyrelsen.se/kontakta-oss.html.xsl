...
<xsl:variable name="filename" select="'http://www.lansstyrelsen.se/vasterbotten/En/kontakta-oss/Pages/default.aspx'"/>
...
<xsl:variable name="parallels">
  ...
  <!-- <parallel_text xml:lang="swe" location=""/> -->
	...
	<parallel_text xml:lang="fin" location="kontakta-oss.html"/>
