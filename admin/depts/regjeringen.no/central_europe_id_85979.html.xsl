...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/department_european/central_europe.html?id=85979'"/>
...
<xsl:variable name="para_nob" select="'seksjon_for_sentral-europa_og_eos-finans.html?id=85979'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon_for_sentral-europa_og_eos-finans.html_id=85979" xml:lang="nob"/>
	<parallel_text location="gaska-eurohpa-ja-eesa-ruhtadanortnegiid-sekuvdna-seef.html_id=85979" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
