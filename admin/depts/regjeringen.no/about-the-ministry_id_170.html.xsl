...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry.html?id=170'"/>
...
<xsl:variable name="para_nob" select="'dep.html?id=170'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="om-departementetnn.html_id=170" xml:lang="nno"/>
	<parallel_text location="dep.html_id=170" xml:lang="nob"/>
	<parallel_text location="depatemeantta-birra.html_id=170" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
