...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/Site-Map.html?id=313850'"/>
...
<xsl:variable name="para_nob" select="'nettstedskart.html?id=313850'"/>
