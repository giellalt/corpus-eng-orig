...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/Whats-new/News.html?id=677'"/>
...
<xsl:variable name="para_nob" select="'nyheter.html?id=677'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nyheiter.html_id=677" xml:lang="nno"/>
	<parallel_text location="nyheter.html_id=677" xml:lang="nob"/>
	<parallel_text location="preassaguovdda.html_id=677" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
