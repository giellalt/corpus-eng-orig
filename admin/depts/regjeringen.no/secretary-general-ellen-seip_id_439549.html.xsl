...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/Administrative-leadership/Secretary-General-Ellen-Seip.html?id=439549'"/>
...
<xsl:variable name="para_nob" select="'departementsrad-ellen-seip.html?id=439549'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="departementsrad-ellen-seip.html_id=439549" xml:lang="nob"/>
	<parallel_text location="departemeantarai-ellen-seip.html_id=439549" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
