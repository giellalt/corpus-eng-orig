...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/Site-Map.html?id=313854'"/>
...
<xsl:variable name="para_nob" select="'nettstedskart.html?id=313854'"/>
