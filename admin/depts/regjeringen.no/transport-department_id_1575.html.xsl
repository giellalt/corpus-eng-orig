...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/organisation/departments/transport-department.html?id=1575'"/>
...
<xsl:variable name="para_nob" select="'transportavdelingen.html?id=1575'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="transportavdelinga-ta.html_id=1575" xml:lang="nno"/>
	<parallel_text location="transportavdelingen.html_id=1575" xml:lang="nob"/>
	<parallel_text location="fievrredanossodat.html_id=1575" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
