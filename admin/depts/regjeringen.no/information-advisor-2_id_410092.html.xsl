...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments/department-of-information-and-communicat/Information-Advisor-2.html?id=410092'"/>
...
<xsl:variable name="para_nob" select="'informasjonsradgiver-anne-berit-herstad.html?id=410092'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kommunikasjonsradgjevar-2.html_id=410092" xml:lang="nno"/>
	<parallel_text location="informasjonsradgiver-anne-berit-herstad.html_id=410092" xml:lang="nob"/>
	<parallel_text location="fung-kommunikasjonssjef-anne-berit-herst.html_id=410092" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
