...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/Guided-tour.html?id=313861'"/>
...
<xsl:variable name="para_nob" select="'nettstedskart.html?id=313861'"/>
