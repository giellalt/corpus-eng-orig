...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/The-Office-of-the-Prime-Minister/contact.html?id=883'"/>
...
<xsl:variable name="para_nob" select="'kontakt.html?id=883'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kontakt.html_id=883" xml:lang="nno"/>
	<parallel_text location="kontakt.html_id=883" xml:lang="nob"/>
	<parallel_text location="oktavuohta.html_id=883" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
