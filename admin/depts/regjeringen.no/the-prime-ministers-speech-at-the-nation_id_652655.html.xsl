...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new/Speeches-and-articles/statsministeren/statsminister_jens_stoltenberg/2011/the-prime-ministers-speech-at-the-nation.html?id=652655'"/>
...
<xsl:variable name="para_nob" select="'statsministerens-tale-ved-nasjonal-minne.html_id=652655'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statsministerens-tale-ved-nasjonal-minne.html_id=652655" xml:lang="nob"/>
	<parallel_text location="stahtaministara-sardni-2272011-naunala-m.html_id=652655" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
