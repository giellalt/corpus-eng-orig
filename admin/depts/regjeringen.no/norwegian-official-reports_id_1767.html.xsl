...
<xsl:variable name="filename" select="'http://regjeringen.no/en/doc/norwegian-official-reports.html?id=1767'"/>
...
<xsl:variable name="para_nob" select="'nouer.html?id=1767'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nou-ar.html_id=1767" xml:lang="nno"/>
	<parallel_text location="nouer.html_id=1767" xml:lang="nob"/>
	<parallel_text location="na-at.html_id=1767" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
