...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-press-and-communications-division/kristin-hetle.html?id=509263'"/>
...
<xsl:variable name="para_nob" select="'kristin-hetle.html?id=509263'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kristin-hetle.html_id=509263" xml:lang="nob"/>
	<parallel_text location="gulahallanhoavda-kristin-hetle.html_id=509263" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
