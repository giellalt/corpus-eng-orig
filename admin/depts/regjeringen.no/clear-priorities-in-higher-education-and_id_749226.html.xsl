...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/press-contacts/Press-releases/2014/clear-priorities-in-higher-education-and.html?id=749226'"/>
...
<xsl:variable name="para_nob" select="'klare-prioriteringer-i-hoyere-utdanning-.html_id=749226'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="klare-prioriteringer-i-hoyere-utdanning-_id_749226.html" xml:lang="nob"/>
