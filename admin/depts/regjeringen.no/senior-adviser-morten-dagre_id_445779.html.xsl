...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-press-and-communications-division/senior-adviser-morten-dagre.html?id=445779'"/>
...
<xsl:variable name="para_nob" select="'morten-dagre.html?id=445779'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="morten-dagre.html_id=445779" xml:lang="nob"/>
	<parallel_text location="seniorraeaddi-morten-dagre.html_id=445779" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
