...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/Organisation/Departments/Cultural-Heritage-Department/acting-director-general-roy-kristiansen.html?id=590197'"/>
...
<xsl:variable name="para_nob" select="'fungerende-ekspedisjonssjef-roy-kristian.html?id=590197'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fungerande-ekspedisjonssjef-roy-kristian.html_id=590197" xml:lang="nno"/>
	<parallel_text location="fungerende-ekspedisjonssjef-roy-kristian.html_id=590197" xml:lang="nob"/>
	<parallel_text location="sadjasa-ekspediuvdnahoavda-roy-kristians.html_id=590197" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
