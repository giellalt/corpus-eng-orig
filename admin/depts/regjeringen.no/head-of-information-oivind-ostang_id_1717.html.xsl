...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/The-Office-of-the-Prime-Minister/Organisation/Departments/press-and-information-section/Head-of-Information-Oivind-Ostang.html?id=1717'"/>
...
<xsl:variable name="para_nob" select="'seniorradgiver_oivind_ostang.html?id=1717'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seniorradgiver_oivind_ostang.html_id=1717" xml:lang="nob"/>
	<parallel_text location="informauvdnahoavda-oivind-ostang.html_id=1717" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
