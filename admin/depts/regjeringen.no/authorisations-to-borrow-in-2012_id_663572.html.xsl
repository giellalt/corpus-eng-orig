...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/press-center/press-releases/2011/authorisations-to-borrow-in-2012.html?id=663572'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Fápmudus váldit stáhtaloana 2012 - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'fullmakt-til-opptak-av-statslan-i-2012.html_id=663572'"/>
<xsl:variable name="para_nob" select="'pm_melding_nord.html_id=663707'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fapmudus-valdit-stahtaloana-2012.html_id=663572'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fullmakt-til-opptak-av-statslan-i-2012.html_id=663572" xml:lang="nno"/>
	<parallel_text location="pm_melding_nord.html_id=663707" xml:lang="nob"/>
	<parallel_text location="fapmudus-valdit-stahtaloana-2012.html_id=663572" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
