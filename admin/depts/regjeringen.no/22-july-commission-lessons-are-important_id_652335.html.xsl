...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2011/22-july-commission-lessons-are-important.html?id=652335'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="14-millionar-kroner-i-bulystmidlar-til-u_id_653601.html"/>
        <parallel_text xml:lang="nob" location="viktig-a-trekke-lardom-for-bedre-fremt_id_652335.html"/>
