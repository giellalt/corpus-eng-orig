...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2010/treaty.html?id=614254'"/>
<xsl:variable name="title" select="'Treaty on maritime delimitation and cooperation in the Barents Sea and the Arctic Ocean signed today - regjeringen.no'"/>
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'1390'"/>
=======
<xsl:variable name="wordcount" select="'1399'"/>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
...
<xsl:variable name="para_nob" select="'avtalen.html?id=614254'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avtalen.html_id=614254" xml:lang="nob"/>
	<parallel_text location="murmanskkas.html_id=614254" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
