...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/the-department-of-administrative-affairs.html?id=1541'"/>
...
<xsl:variable name="para_nob" select="'administrasjonsavdelingen.html?id=1541'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="administrasjonsavdelinga.html_id=1541" xml:lang="nno"/>
	<parallel_text location="administrasjonsavdelingen.html_id=1541" xml:lang="nob"/>
	<parallel_text location="halldahusodat.html_id=1541" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
