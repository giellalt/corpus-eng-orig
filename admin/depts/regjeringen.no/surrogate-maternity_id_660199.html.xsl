...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/whats-new/News/2011/surrogate-maternity.html?id=660199'"/>
...
<xsl:variable name="para_nob" select="'surrogati.html_id=660199'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="surrogati.html_id=660199" xml:lang="nno"/>
	<parallel_text location="surrogati.html_id=660199" xml:lang="nob"/>
