...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new/Speeches-and-articles/statsministeren/statsminister_jens_stoltenberg/2012/speech-at-rembrance-consert.html?id=696944'"/>
...
<xsl:variable name="para_nob" select="'tale-ved-minnekonsert.html_id=696944'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tale-ved-minnekonsert.html_id=696944" xml:lang="nob"/>
	<parallel_text location="sardni-raeviessoilju-muitokonsearttas.html_id=696944" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
