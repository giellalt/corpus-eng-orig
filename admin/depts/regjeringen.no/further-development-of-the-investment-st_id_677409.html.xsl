...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/press-center/press-releases/2012/further-development-of-the-investment-st.html?id=677409'"/>
...
<xsl:variable name="para_nob" select="'videreutvikling-av-investeringsstrategie.html_id=677409'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="videreutvikling-av-investeringsstrategie_id_677409.html" xml:lang="nob"/>
