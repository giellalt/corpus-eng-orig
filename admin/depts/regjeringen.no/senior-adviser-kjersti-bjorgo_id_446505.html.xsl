...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/Organisation/Departments/The-Communication-Unit/senior-adviser-kjersti-bjorgo.html?id=446505'"/>
...
<xsl:variable name="para_nob" select="'kbj.html?id=446505'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kbj.html_id=446505" xml:lang="nob"/>
	<parallel_text location="seniorraeaddi-kjersti-bjorgo.html_id=446505" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
