...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/The-Office-of-the-Prime-Minister/Organisation/Departments/press-and-information-section/communication-officer-tor-aagaard-borger.html?id=481482'"/>
...
<xsl:variable name="para_nob" select="'kommunikasjonsradgiver-tor-aagaard-borge.html?id=481482'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kommunikasjonsradgiver-tor-aagaard-borge.html_id=481482" xml:lang="nob"/>
	<parallel_text location="diehtojuohkinraeaddi-tor-aagaard-borgers.html_id=481482" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
