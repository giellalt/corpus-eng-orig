...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/communication-unit.html?id=439584'"/>
...
<xsl:variable name="para_nob" select="'kommunikasjonsenheten.html?id=439584'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kommunikasjonseininga.html_id=439584" xml:lang="nno"/>
	<parallel_text location="kommunikasjonsenheten.html_id=439584" xml:lang="nob"/>
	<parallel_text location="gulahallanovttadat.html_id=439584" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
