...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Underliggende-etater/The-Norwegian-Government-Agency-for-Fina.html?id=270409'"/>
...
<xsl:variable name="para_nob" select="'senter-for-statlig-okonomistyring.html?id=270409'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="senter-for-statleg-okonomistyring.html_id=270409" xml:lang="nno"/>
	<parallel_text location="senter-for-statlig-okonomistyring.html_id=270409" xml:lang="nob"/>
	<parallel_text location="stahta-ekonomiijastivrenguovdda.html_id=270409" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
