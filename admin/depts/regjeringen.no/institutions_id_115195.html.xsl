...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Institutions.html?id=115195'"/>
...
<xsl:variable name="para_nob" select="'tilknyttede-virksomheter.html?id=115195'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tilknytta-verksemder.html_id=115195" xml:lang="nno"/>
	<parallel_text location="tilknyttede-virksomheter.html_id=115195" xml:lang="nob"/>
	<parallel_text location="daidda-gulleva-doaimmat.html_id=115195" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
