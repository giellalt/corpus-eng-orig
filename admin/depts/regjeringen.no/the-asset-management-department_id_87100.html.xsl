...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/the-asset-management-department.html?id=87100'"/>
...
<xsl:variable name="para_nob" select="'formuesforvaltning.html?id=87100'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdeling-for-formuesforvaltning-aff.html_id=87100" xml:lang="nno"/>
	<parallel_text location="formuesforvaltning.html_id=87100" xml:lang="nob"/>
	<parallel_text location="opmodagaid-halddaanossodat-.html_id=87100" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
