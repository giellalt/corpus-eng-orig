...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2009/norway-presents-new-measures-for-industr.html?id=545250'"/>
...
<xsl:variable name="para_nob" select="'nye-tiltak-for-naringsliv-og-husholdning.html?id=545250'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nye-tiltak-for-naringsliv-og-husholdning.html_id=545250" xml:lang="nob"/>
	<parallel_text location="oa-doaibmabijut-ealahusaide-ja-dallodoal.html_id=545250" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
