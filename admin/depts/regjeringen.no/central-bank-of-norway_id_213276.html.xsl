...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Related-Institutions/Central-Bank-of-Norway.html?id=213276'"/>
...
<xsl:variable name="para_nob" select="'norges-bank.html?id=213276'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="noregs-bank.html_id=213276" xml:lang="nno"/>
	<parallel_text location="norges-bank.html_id=213276" xml:lang="nob"/>
	<parallel_text location="norga-baku.html_id=213276" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
