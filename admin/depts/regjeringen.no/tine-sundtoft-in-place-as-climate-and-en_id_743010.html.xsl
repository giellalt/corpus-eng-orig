...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/press-centre/Press-releases/2013/tine-sundtoft-in-place-as-climate-and-en.html?id=743010'"/>
...
<xsl:variable name="para_nob" select="'tine-sundtoft-pa-plass-som-klima--og-mil.html_id=743010'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tine-sundtoft-pa-plass-som-klima--og-mil.html_id=743010" xml:lang="nob"/>
	<parallel_text location="tine-sundtoft-birasgahttenministtarin.html_id=743010" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
