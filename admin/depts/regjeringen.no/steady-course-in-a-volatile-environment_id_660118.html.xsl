...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/press-center/press-releases/2011/steady-course-in-a-volatile-environment.html?id=660118'"/>
...
<xsl:variable name="para_nob" select="'et-budsjett-for-a-trygge-arbeidsplasser-.html_id=660118'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="et-budsjett-for-a-trygge-arbeidsplasser-.html_id=660118" xml:lang="nob"/>
	<parallel_text location="bueahtain-oadjebas-bargosajit-arvorahkad.html_id=660118" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
