...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/whats-new/Speeches-and-articles/minister.html?id=573146'"/>
...
<xsl:variable name="para_nob" select="'ministeren.html?id=573146'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ministaren.html_id=573146" xml:lang="nno"/>
	<parallel_text location="ministeren.html_id=573146" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
