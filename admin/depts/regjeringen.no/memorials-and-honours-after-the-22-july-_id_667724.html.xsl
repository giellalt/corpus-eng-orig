...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/press-centre/pressemeldinger/2011/memorials-and-honours-after-the-22-july-.html?id=667724'"/>
...
<xsl:variable name="para_nob" select="'minnesmerker-og-hedring-etter-angrepene-.html_id=667724'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minnesmerker-og-hedring-etter-angrepene-.html_id=667724" xml:lang="nob"/>
	<parallel_text location="muitobaccit-ja-gudnejahttimat-mail-suoid.html_id=667724" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
