...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/policy-for-lifelong-learning.html?id=1407'"/>
...
<xsl:variable name="para_nob" select="'utdanning_og_kompetanse.html?id=1407'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utdanning_og_kompetanse.html_id=1407" xml:lang="nob"/>
	<parallel_text location="gelbbolavuoapolitihkka.html_id=1407" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
