...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/other-political-staff/state-secretary-lars-erik-bartnes/photo-gallery---state-secretary-lars-eri.html?id=582358'"/>
...
<xsl:variable name="para_nob" select="'bilder-av-statssekretar-leif-erik-bartne.html?id=582358'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bilder-av-statssekretar-lars-erik-bartne.html_id=582358" xml:lang="nno"/>
	<parallel_text location="bilder-av-statssekretar-leif-erik-bartne.html_id=582358" xml:lang="nob"/>
	<parallel_text location="govvavuorka---stahtaalli-lars-erik-bartn.html_id=582358" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
