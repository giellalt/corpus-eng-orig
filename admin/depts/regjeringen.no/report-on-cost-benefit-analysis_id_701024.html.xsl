...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/press-center/press-releases/2012/report-on-cost-benefit-analysis.html?id=701024'"/>
...
<xsl:variable name="para_nob" select="'utredning-om-samfunnsokonomiske-analys-2.html_id=701024'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utredning-om-samfunnsokonomiske-analys-2.html_id=701024" xml:lang="nob"/>
	<parallel_text location="servodatekonomiija-analysaid-guorahallan.html_id=701024" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
