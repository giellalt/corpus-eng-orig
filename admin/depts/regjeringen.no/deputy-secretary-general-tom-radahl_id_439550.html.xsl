...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/Administrative-leadership/Deputy-Secretary-General-Tom-Radahl.html?id=439550'"/>
...
<xsl:variable name="para_nob" select="'tom-radahl.html?id=439550'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tom-radahl.html_id=439550" xml:lang="nob"/>
	<parallel_text location="veahkkedepartemeantarai-tom-radahl.html_id=439550" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
