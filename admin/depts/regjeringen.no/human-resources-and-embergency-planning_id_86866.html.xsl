...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/nhd/about-the-ministry/organisation/Departments/administrative-department/human-resources-and-embergency-planning.html?id=86866'"/>
...
<xsl:variable name="para_nob" select="'personal-og-beredskap-pb.html?id=86866'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="personal-og-beredskap-pb.html_id=86866" xml:lang="nob"/>
	<parallel_text location="bargit-ja-gearggusvuohta.html_id=86866" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
