...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/Documents/Reports-programmes-of-action-and-plans/Action-plans-and-programmes/2006/strategy-for-the-high-north.html?id=448697'"/>
...
<xsl:variable name="para_nob" select="'regjeringens-nordomradestrategi.html?id=448697'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringens-nordomradestrategi.html_id=448697" xml:lang="nob"/>
	<parallel_text location="strategi_samisk.html_id=448697" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
