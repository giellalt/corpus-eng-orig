...
<xsl:variable name="filename" select="'http://regjeringen.no/en/the-government/the-government-at-work.html?id=443781'"/>
...
<xsl:variable name="para_nob" select="'regjeringen-i-arbeid.html?id=443781'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="slik-arbeider-regjeringa.html_id=443781" xml:lang="nno"/>
	<parallel_text location="regjeringen-i-arbeid.html_id=443781" xml:lang="nob"/>
	<parallel_text location="raehusa-bargu.html_id=443781" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
