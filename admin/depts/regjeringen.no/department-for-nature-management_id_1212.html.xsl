...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-nature-management.html?id=1212'"/>
...
<xsl:variable name="para_nob" select="'naturforvaltning.html?id=1212'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="naturforvaltning.html_id=1212" xml:lang="nob"/>
	<parallel_text location="luondduhalddaanossodat.html_id=1212" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
