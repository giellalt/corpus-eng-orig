...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/Subordinate-agencies/the-norwegian-mapping-authority.html?id=85701'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statens_kartverk.html_id=85701" xml:lang="nob"/>
	<parallel_text location="stada-kartadoaimmahat.html_id=85701" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
