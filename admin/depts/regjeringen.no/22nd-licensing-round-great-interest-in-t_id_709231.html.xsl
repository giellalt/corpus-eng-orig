...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed/press-center/press-releases/2012/22nd-licensing-round-great-interest-in-t.html?id=709231'"/>
...
<xsl:variable name="para_nob" select="'22-konsesjonsrunde--stor-interesse-for-n.html_id=709231'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="22-konsesjonsrunde--stor-interesse-for-n.html_id=709231" xml:lang="nob"/>
	<parallel_text location="22-konseuvdnavuorru--stuora-berotupmi-da.html_id=709231" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
