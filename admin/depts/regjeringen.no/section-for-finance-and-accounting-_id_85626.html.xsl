...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-organisational-and-econom/Section-for-Finance-and-Accounting-.html?id=85626'"/>
...
<xsl:variable name="para_nob" select="'budsjett_og_regnskap.html?id=85626'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="budsjett_og_regnskap.html_id=85626" xml:lang="nob"/>
	<parallel_text location="bueahtta--ja-rehketdoallosekuvdna.html_id=85626" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
