...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new/Speeches-and-articles/statsministeren/statsminister_jens_stoltenberg/2011/commemorative-address-by-the-prime-minis.html?id=651974'"/>
...
<xsl:variable name="para_nob" select="'tale1.html_id=651974'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tale1.html_id=651974" xml:lang="nob"/>
	<parallel_text location="stahtaministara-muitosanit-stuorradikkis.html_id=651974" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
