...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-department-of-welfare-policy.html?id=1456'"/>
...
<xsl:variable name="para_nob" select="'vpa.html?id=1456'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="velferdspolitisk-avdeling.html_id=1456" xml:lang="nno"/>
	<parallel_text location="vpa.html_id=1456" xml:lang="nob"/>
	<parallel_text location="algopolitihkala-ossodat-.html_id=1456" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
