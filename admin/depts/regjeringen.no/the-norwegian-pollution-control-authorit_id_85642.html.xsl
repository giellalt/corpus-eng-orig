...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/Subordinate-agencies/the-norwegian-pollution-control-authorit.html?id=85642'"/>
...
<xsl:variable name="para_nob" select="'statens_forurensningstilsyn.html?id=85642'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statens_forurensningstilsyn.html_id=85642" xml:lang="nob"/>
	<parallel_text location="stada-nuoskkidanbearraigeahus.html_id=85642" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
