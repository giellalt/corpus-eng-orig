...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed/press-center/Press-releases/2009/goliat--an-important-part-of-the-develop.html?id=560593'"/>
...
<xsl:variable name="para_nob" select="'goliat--en-ny-byggestein-i-nord.html?id=560593'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="goliat--en-ny-byggestein-i-nord.html_id=560593" xml:lang="nob"/>
	<parallel_text location="goliat--oa-huksengeagi-davvin.html_id=560593" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
