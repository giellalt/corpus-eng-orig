...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/Subjects/rural-and-regional-policy/development-of-companies-and-business-en.html?id=526842'"/>
...
<xsl:variable name="para_nob" select="'utvikling-av-bedrifter-og-naringsmiljo.html?id=526842'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utvikling-av-bedrifter-og-naringsmiljo.html_id=526842" xml:lang="nob"/>
	<parallel_text location="fitnodagaid-ja-ealahusdoaimmaid-ovdanahttin.html_id=526842" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
