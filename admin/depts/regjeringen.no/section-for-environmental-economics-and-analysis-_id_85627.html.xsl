...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-organisational-and-econom/Section-for-Environmental-Economics-and-Analysis-.html?id=85627'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="miljookonomi_og_analyse.html_id=85627" xml:lang="nob"/>
	<parallel_text location="birasekonomiija-ja-analysa-sekuuvdna.html_id=85627" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
