...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/whats-new/News/2012/norwegian-frigate-to-lead-nato-maritime-.html?id=704821'"/>
...
<xsl:variable name="para_nob" select="'norsk-fregatt-skal-lede-natos-maritime-s.html_id=704821'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norsk-fregatt-skal-lede-natos-maritime-s.html_id=704821" xml:lang="nob"/>
	<parallel_text location="norgga-fregahtta-galga-joihit-nato-mearr.html_id=704821" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
