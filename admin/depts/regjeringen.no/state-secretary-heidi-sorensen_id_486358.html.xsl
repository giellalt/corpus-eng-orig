...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/Other-political-staff/state-secretary-heidi-sorensen.html?id=486358'"/>
...
<xsl:variable name="para_nob" select="'statssekretar-heidi-sorensen.html?id=486358'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statssekretar-heidi-sorensen.html_id=486358" xml:lang="nno"/>
	<parallel_text location="statssekretar-heidi-sorensen.html_id=486358" xml:lang="nob"/>
	<parallel_text location="stahtaalli-heidi-sorensen.html_id=486358" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
