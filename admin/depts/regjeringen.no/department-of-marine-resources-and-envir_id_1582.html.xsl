...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments/department-of-marine-resources-and-envir.html?id=1582'"/>
...
<xsl:variable name="para_nob" select="'ressurs-_og_havavdelingen.html?id=1582'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ressurs--og-havavdelinga.html_id=1582" xml:lang="nno"/>
	<parallel_text location="ressurs-_og_havavdelingen.html_id=1582" xml:lang="nob"/>
	<parallel_text location="resursa--ja-ahpeossodat.html_id=1582" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
