...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/Organisation/Departments/The-Communication-Unit.html?id=1708'"/>
...
<xsl:variable name="para_nob" select="'kommunikasjonsenheten.html?id=1708'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kommunikasjonseininga.html_id=1708" xml:lang="nno"/>
	<parallel_text location="kommunikasjonsenheten.html_id=1708" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
