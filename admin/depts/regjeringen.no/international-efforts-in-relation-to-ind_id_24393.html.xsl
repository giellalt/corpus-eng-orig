...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/international-efforts-in-relation-to-ind.html?id=24393'"/>
...
<xsl:variable name="para_nob" select="'internasjonalt_urfolksarbeid.html?id=24393'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="internasjonalt_urfolksarbeid.html_id=24393" xml:lang="nob"/>
	<parallel_text location="riikkaidgaskasa-algoalbmotbargu.html_id=24393" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
