...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/documents/The-Speech-from-the-Throne.html?id=87094'"/>
...
<xsl:variable name="para_nob" select="'trontaler.html?id=87094'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="trontalen.html_id=87094" xml:lang="nob"/>
	<parallel_text location="gonagassardni.html_id=87094" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
