...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/whats-new/News/2014/the-us-is-our-most-important-ally.html?id=748895'"/>
...
<xsl:variable name="para_nob" select="'-usa-er-var-viktigste-allierte.html_id=748895'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="usa-er-var-viktigste-allierte.html_id=748895" xml:lang="nob"/>
	<parallel_text location="usa-lea-min-mavssoleamos-lihtola.html_id=748895" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
