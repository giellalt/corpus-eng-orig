...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Institutions/The-Norwegian-Seafood-Export-Council-.html?id=164273'"/>
...
<xsl:variable name="para_nob" select="'eksportutvalget-for-fisk.html?id=164273'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="eksportutvalet-for-fisk-.html_id=164273" xml:lang="nno"/>
	<parallel_text location="eksportutvalget-for-fisk.html_id=164273" xml:lang="nob"/>
	<parallel_text location="guoli-olggosfievrredanlavdegottis-.html_id=164273" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
