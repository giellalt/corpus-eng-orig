...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/Department-of-Employer-Policy.html?id=1590'"/>
...
<xsl:variable name="para_nob" select="'arbeidsgiverpolitisk_avdeling.html?id=1590'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arbeidsgiverpolitisk_avdeling.html_id=1590" xml:lang="nob"/>
	<parallel_text location="bargoaddipolitihkala-ossodat.html_id=1590" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
