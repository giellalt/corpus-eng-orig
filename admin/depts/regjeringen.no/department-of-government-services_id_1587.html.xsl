...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/department-of-government-services.html?id=1587'"/>
...
<xsl:variable name="para_nob" select="'statsforvaltningsavdelingen.html?id=1587'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statsforvaltningsavdelingen.html_id=1587" xml:lang="nob"/>
	<parallel_text location="stahtahalddahusossodat.html_id=1587" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
