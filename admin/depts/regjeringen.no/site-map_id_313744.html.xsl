...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/Site-Map.html?id=313744'"/>
...
<xsl:variable name="para_nob" select="'nettstedskart.html?id=313744'"/>
