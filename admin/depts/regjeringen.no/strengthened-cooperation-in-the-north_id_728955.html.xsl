...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2013/strengthened-cooperation-in-the-north.html?id=728955'"/>
...
<xsl:variable name="para_nob" select="'styrket-samarbeid-i-nord.html_id=728955'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="styrket-samarbeid-i-nord.html_id=728955" xml:lang="nob"/>
	<parallel_text location="nannejuvvon-ovttasbargu-davvin.html_id=728955" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
