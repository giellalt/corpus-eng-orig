...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Institutions/The-National-Veterinary-Institute.html?id=168615'"/>
...
<xsl:variable name="para_nob" select="'veterinarinstituttet.html?id=168615'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="veterinarinstituttet.html_id=168615" xml:lang="nno"/>
	<parallel_text location="veterinarinstituttet.html_id=168615" xml:lang="nob"/>
	<parallel_text location="veterinearainstituhtta.html_id=168615" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
