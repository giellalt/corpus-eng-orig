...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/contact.html?id=471'"/>
...
<xsl:variable name="para_nob" select="'kontakt.html?id=471'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kontakt.html_id=471" xml:lang="nno"/>
	<parallel_text location="kontakt.html_id=471" xml:lang="nob"/>
	<parallel_text location="oktavuohta.html_id=471" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
