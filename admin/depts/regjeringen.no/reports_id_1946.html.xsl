...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/documents/reports/reports.html?id=1946'"/>
...
<xsl:variable name="para_nob" select="'rapporter.html?id=1946'"/>
