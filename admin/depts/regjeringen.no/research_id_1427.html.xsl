...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/research.html?id=1427'"/>
...
<xsl:variable name="para_nob" select="'forskning.html?id=1427'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskning.html_id=1427" xml:lang="nob"/>
	<parallel_text location="dutkan.html_id=1427" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
