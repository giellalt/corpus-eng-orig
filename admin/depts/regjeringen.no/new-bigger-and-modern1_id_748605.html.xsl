...
<xsl:variable name="author1_ln" select="'Ministry of Local Government and Modernisation'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="nytt-storre-moderne_id_748605.html" xml:lang="nob"/>
