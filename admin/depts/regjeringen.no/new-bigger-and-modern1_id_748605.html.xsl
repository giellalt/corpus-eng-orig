...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kmd/press/press-releases/2014/new-bigger-and-modern1.html?id=748605'"/>
...
<xsl:variable name="para_nob" select="'nytt-storre-moderne.html_id=748605'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="nytt-storre-moderne.html_id=748605" xml:lang="nob"/>
	<parallel_text location="oaseabbo-stuorit-ja-oaaigasa1.html_id=748605" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
