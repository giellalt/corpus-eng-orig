...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/the-ministry/organisation/Departments/the-ministry-of-defence-communication-un.html?id=521818'"/>
...
<xsl:variable name="para_nob" select="'kommunikasjonsenhet.html?id=521818'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kommunikasjonseining.html_id=521818" xml:lang="nno"/>
	<parallel_text location="kommunikasjonsenhet.html_id=521818" xml:lang="nob"/>
	<parallel_text location="gulahallanovttadat.html_id=521818" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
