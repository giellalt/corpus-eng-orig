...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd.html?id=504'"/>
...
<xsl:variable name="para_nob" select="'krd.html?id=504'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="krd.html_id=504" xml:lang="nno"/>
	<parallel_text location="krd.html_id=504" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
