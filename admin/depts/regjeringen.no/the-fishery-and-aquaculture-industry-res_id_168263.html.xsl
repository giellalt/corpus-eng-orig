...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Institutions/the-fishery-and-aquaculture-industry-res.html?id=168263'"/>
...
<xsl:variable name="para_nob" select="'fhf.html?id=168263'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskingsfondet-til-fiskeri--og-havbruksnaringa-.html_id=168263" xml:lang="nno"/>
	<parallel_text location="fhf.html_id=168263" xml:lang="nob"/>
	<parallel_text location="fhf.html_id=168263" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
