...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/Subjects/Housing-and-building-policy.html?id=943'"/>
...
<xsl:variable name="para_nob" select="'bolig-_og_bygningspolitikk.html?id=943'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bolig-_og_bygningspolitikk.html_id=943" xml:lang="nob"/>
	<parallel_text location="assan--ja-huksenpolitihkka.html_id=943" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
