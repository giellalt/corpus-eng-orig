...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed/press-center/Press-releases/2007/The-right-of-reversion--The-Government-s.html?id=477332'"/>
...
<xsl:variable name="para_nob" select="'Hjemfall-Regjeringen-sikrer-offentlig-ei.html?id=477332'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hjemfall-regjeringen-sikrer-offentlig-ei.html_id=477332" xml:lang="nob"/>
	<parallel_text location="maasmahcaheapmi-raehus-sihkkarasta-almmo.html_id=477332" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
