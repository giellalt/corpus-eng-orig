...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/press-centre/press-releases/2008/a-positive-attitude-towards-labour-migra.html?id=508327'"/>
...
<xsl:variable name="para_nob" select="'positiv-holdning-til-arbeidsinnvandring.html?id=508327'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="positiv-holdning-til-arbeidsinnvandring.html_id=508327" xml:lang="nob"/>
	<parallel_text location="positiiva-oaidnu-bargosisfarremii.html_id=508327" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
