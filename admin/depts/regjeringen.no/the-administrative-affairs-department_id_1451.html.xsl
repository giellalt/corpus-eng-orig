...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization/Departments/The-Administrative-Affairs-Department.html?id=1451'"/>
...
<xsl:variable name="para_nob" select="'plan-_og_administrasjonsavdelingen.html?id=1451'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="plan--og-administrasjonsshyavdelinga.html_id=1451" xml:lang="nno"/>
	<parallel_text location="plan-_og_administrasjonsavdelingen.html_id=1451" xml:lang="nob"/>
	<parallel_text location="plana--ja-halddahusossodat.html_id=1451" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
