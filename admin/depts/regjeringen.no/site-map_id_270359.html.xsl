...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Site-Map.html?id=270359'"/>
...
<xsl:variable name="para_nob" select="'nettstedskart.html?id=270359'"/>
