...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/Senior-administrative-staff/secretary-general-harald-rensvik.html?id=85697'"/>
...
<xsl:variable name="para_nob" select="'departementsrad_harald_rensvik.html?id=85697'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="departementsrad_harald_rensvik.html_id=85697" xml:lang="nob"/>
	<parallel_text location="departemeantarai-harald-rensvik.html_id=85697" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
