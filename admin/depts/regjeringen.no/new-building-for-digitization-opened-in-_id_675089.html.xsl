...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kud/Whats-new/news/2012/new-building-for-digitization-opened-in-.html?id=675089'"/>
...
<xsl:variable name="para_nob" select="'kulturministeren-apnet-nytt-digitaliseri.html_id=675089'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kulturministeren-apnet-nytt-digitaliseri.html_id=675089" xml:lang="nob"/>
	<parallel_text location="kulturministtar-rabai-oa-digitaliserengu.html_id=675089" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
