...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new/Speeches-and-articles/statsministeren/statsminister_jens_stoltenberg/2011/address-by-prime-minister-in-oslo-cathed.html?id=651789'"/>
...
<xsl:variable name="para_nob" select="'tale-ved-statsminister-jens-stoltenberg-.html_id=651789'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tale-ved-statsminister-jens-stoltenberg-.html_id=651789" xml:lang="nob"/>
	<parallel_text location="stahtaministara-jens-stoltenberg-sardni-.html_id=651789" xml:lang="sme"/>
