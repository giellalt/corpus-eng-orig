...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="det-blir-enklare-a-forehandsstemme_id_710339.html"/>
        <parallel_text xml:lang="nob" location="nye-forsok-med-internettstemming-i-2013_id_710138.html"/>
