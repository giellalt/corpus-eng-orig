...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2012/new-pilot-with-internet-voting-in-2013.html?id=710138'"/>
...
<xsl:variable name="para_nob" select="'nye-forsok-med-internettstemming-i-2013.html_id=710138'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="nye-forsok-med-internettstemming-i-2013.html_id=710138" xml:lang="nob"/>
	<parallel_text location="oa-geahaleamit-interneahttajienastemiin-.html_id=710138" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
