...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/Tertiary-Vocational-Education-.html?id=87103'"/>
...
<xsl:variable name="para_nob" select="'fagskoleutdanning.html?id=87103'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fagskoleutdanning.html_id=87103" xml:lang="nob"/>
	<parallel_text location="fagaskuvlaoahppu.html_id=87103" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
