...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/Subordinate-agencies/The-Directorate-for-Nature-Management.html?id=85704'"/>
...
<xsl:variable name="para_nob" select="'direktoratet_for_naturforvaltning.html?id=85704'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="direktoratet_for_naturforvaltning.html_id=85704" xml:lang="nob"/>
	<parallel_text location="luondduhalddaan-direktorahta.html_id=85704" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
