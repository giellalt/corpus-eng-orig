...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-press-and-communications-division/senior-adviser-gro-orsal.html?id=445778'"/>
...
<xsl:variable name="para_nob" select="'gro-orsal.html?id=445778'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gro-orsal.html_id=445778" xml:lang="nob"/>
	<parallel_text location="seniorraeaddi-gro-orsal.html_id=445778" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
