...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/ethnic-discrimination.html?id=1145'"/>
...
<xsl:variable name="para_nob" select="'rasisme_og_diskriminering.html?id=1145'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rasisme_og_diskriminering.html_id=1145" xml:lang="nob"/>
	<parallel_text location="earddala-vealaheapmi.html_id=1145" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
