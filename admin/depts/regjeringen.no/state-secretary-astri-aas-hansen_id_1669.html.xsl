...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Other-political-staff/State-Secretary-Astri-Aas-Hansen.html?id=1669'"/>
...
<xsl:variable name="para_nob" select="'astri_aas_hansen.html?id=1669'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="astri_aas_hansen.html_id=1669" xml:lang="nno"/>
	<parallel_text location="astri_aas_hansen.html_id=1669" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
