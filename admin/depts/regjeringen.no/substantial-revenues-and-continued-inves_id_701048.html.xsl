...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed/press-center/press-releases/2012/substantial-revenues-and-continued-inves.html?id=701048'"/>
...
<xsl:variable name="para_nob" select="'hoye-inntekter-og-videre-satsing-pa-petr.html_id=701048'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hoye-inntekter-og-videre-satsing-pa-petr.html_id=701048" xml:lang="nob"/>
	<parallel_text location="alla-dietnasat-ja-joatkkaagiruan-petrole.html_id=701048" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
