...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/communication-unit/communication-adviser-ann-kristin-lindaa.html?id=439589'"/>
<xsl:variable name="title" select="'Senior gulahallanrávvejeaddji Ann Kristin Lindaas - regjeringen.no'"/>
<xsl:variable name="author1_fn" select="''"/>
<xsl:variable name="author1_ln" select="'Ministry of Government Administration, Reform and Church Affairs'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="informasjonsradgiver-ann-kristin-lindaas_id_439589.html" xml:lang="nob"/>
