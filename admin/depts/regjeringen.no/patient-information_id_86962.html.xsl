...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/Subjects/patient-information.html?id=86962'"/>
...
<xsl:variable name="para_nob" select="'pasientinformasjon.html?id=86962'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pasientinformasjon.html_id=86962" xml:lang="nob"/>
	<parallel_text location="divohasdiehtojuohkin.html_id=86962" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
