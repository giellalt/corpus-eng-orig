...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Institutions/innovation-norway-.html?id=168036'"/>
...
<xsl:variable name="para_nob" select="'innovasjon-norge.html?id=168036'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="innovasjon-noreg.html_id=168036" xml:lang="nno"/>
	<parallel_text location="innovasjon-norge.html_id=168036" xml:lang="nob"/>
	<parallel_text location="innovauvdna-norga-.html_id=168036" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
