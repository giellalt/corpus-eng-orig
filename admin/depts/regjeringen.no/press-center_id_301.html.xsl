...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Press-Center.html?id=301'"/>
...
<xsl:variable name="para_nob" select="'pressesenter.html?id=301'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pressesenter.html_id=301" xml:lang="nno"/>
	<parallel_text location="pressesenter.html_id=301" xml:lang="nob"/>
	<parallel_text location="preassaguovdda.html_id=301" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
