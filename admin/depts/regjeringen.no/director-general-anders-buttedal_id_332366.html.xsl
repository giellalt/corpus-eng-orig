...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/organisation/departments/department-of-planning-administration-an/director-general-anders-buttedal.html?id=332366'"/>
...
<xsl:variable name="para_nob" select="'ekspedisjonssjef-anders-buttedahl.html?id=332366'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekspedisjonssjef-anders-buttedahl.html_id=332366" xml:lang="nno"/>
	<parallel_text location="ekspedisjonssjef-anders-buttedahl.html_id=332366" xml:lang="nob"/>
	<parallel_text location="ekspediuvdnahoavda-anders-buttedahl.html_id=332366" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
