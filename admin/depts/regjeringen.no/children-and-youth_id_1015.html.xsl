...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/Children-and-youth.html?id=1015'"/>
...
<xsl:variable name="para_nob" select="'barn_og_ungdom.html?id=1015'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="barn_og_ungdom.html_id=1015" xml:lang="nob"/>
	<parallel_text location="manat-ja-nuorat.html_id=1015" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
