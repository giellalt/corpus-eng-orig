...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-environmental-data-pollut/section-for-hazardous-substances-and-and.html?id=85643'"/>
...
<xsl:variable name="para_nob" select="'kjemikalier_og_avfall.html?id=85643'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kjemikalier_og_avfall.html_id=85643" xml:lang="nob"/>
	<parallel_text location="kemikala--ja-doapparsekuvdna.html_id=85643" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
