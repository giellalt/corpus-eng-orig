...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/equality.html?id=1246'"/>
...
<xsl:variable name="para_nob" select="'likestillingsomradet.html?id=1246'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="likestillingsomradet.html_id=1246" xml:lang="nob"/>
	<parallel_text location="dassearvu-sohkabeliid-gaskkas.html_id=1246" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
