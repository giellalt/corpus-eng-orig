...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/Subjects/rural-and-regional-policy.html?id=1238'"/>
...
<xsl:variable name="para_nob" select="'regional-_og_distriktspolitikk.html?id=1238'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regional-_og_distriktspolitikk.html_id=1238" xml:lang="nob"/>
	<parallel_text location="guovllu--ja-regionalapolitihkka.html_id=1238" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
