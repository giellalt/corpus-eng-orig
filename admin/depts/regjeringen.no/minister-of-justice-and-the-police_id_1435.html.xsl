...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/minister-of-justice-and-the-police.html?id=1435'"/>
...
<xsl:variable name="para_nob" select="'justisminister_knut_storberget.html?id=1435'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="justisminister-knut-storberget.html_id=1435" xml:lang="nno"/>
	<parallel_text location="justisminister_knut_storberget.html_id=1435" xml:lang="nob"/>
	<parallel_text location="stahtarai-knut-storberget.html_id=1435" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
