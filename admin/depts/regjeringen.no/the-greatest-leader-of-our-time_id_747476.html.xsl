...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2013/the-greatest-leader-of-our-time.html?id=747476'"/>
...
<xsl:variable name="para_nob" select="'den-storste-i-var-tid.html_id=747476'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="den-storste-i-var-tid.html_id=747476" xml:lang="nob"/>
	<parallel_text location="mailbmi-lea-massan-ieas-stuorimus-politi.html_id=747476" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
