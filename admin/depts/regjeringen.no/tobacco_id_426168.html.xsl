...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/Subjects/the-department-of-public-health/Tobacco.html?id=426168'"/>
...
<xsl:variable name="para_nob" select="'tobakk.html?id=426168'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tobakk.html_id=426168" xml:lang="nob"/>
	<parallel_text location="eastadit-duhpatvigiid.html_id=426168" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
