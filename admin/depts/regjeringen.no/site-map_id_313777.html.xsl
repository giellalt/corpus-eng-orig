...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Site-Map.html?id=313777'"/>
...
<xsl:variable name="para_nob" select="'nettstedskart.html?id=313777'"/>
