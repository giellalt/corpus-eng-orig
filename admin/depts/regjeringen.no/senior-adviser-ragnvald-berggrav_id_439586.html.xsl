...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/communication-unit/senior-adviser-ragnvald-berggrav.html?id=439586'"/>
...
<xsl:variable name="para_nob" select="'seniorradgiver.html?id=439586'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seniorradgiver.html_id=439586" xml:lang="nob"/>
	<parallel_text location="senior-gulahallanravvejeaddji-ragnvald-berggrav.html_id=439586" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
