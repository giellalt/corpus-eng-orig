...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/whats-new/news/2011/april-11/food-power-and-impotence.html?id=640277'"/>
...
<xsl:variable name="para_nob" select="'mat-makt-og-avmakt.html_id=640277'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mat-makt-og-avmakt.html_id=640277" xml:lang="nob"/>
	<parallel_text location="borramu-fapmu-ja-famuhisvuohta.html_id=640277" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
