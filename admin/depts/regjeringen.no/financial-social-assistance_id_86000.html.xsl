...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/topics/welfare-policy/midtspalte/financial-social-assistance.html?id=86000'"/>
...
<xsl:variable name="para_nob" select="'okonomisk_sosialhjelp.html?id=86000'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okonomisk_sosialhjelp.html_id=86000" xml:lang="nob"/>
	<parallel_text location="ekonomala-sosialaveahkki.html_id=86000" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
