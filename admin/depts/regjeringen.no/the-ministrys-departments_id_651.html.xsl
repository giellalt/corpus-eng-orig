...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/the-ministry-of-agriculture-and-food/the-ministrys-departments.html?id=651'"/>
...
<xsl:variable name="para_nob" select="'org.html?id=651'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="organisasjon.html_id=651" xml:lang="nno"/>
	<parallel_text location="org.html_id=651" xml:lang="nob"/>
	<parallel_text location="organisauvdna.html_id=651" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
