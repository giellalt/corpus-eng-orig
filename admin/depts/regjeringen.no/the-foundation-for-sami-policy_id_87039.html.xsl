...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/midtspalte/the-foundation-for-sami-policy.html?id=87039'"/>
...
<xsl:variable name="para_nob" select="'grunnlaget-for-samepolitikken.html?id=87039'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="grunnlaget-for-samepolitikken.html_id=87039" xml:lang="nob"/>
	<parallel_text location="samepolitihka-vuou.html_id=87039" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
