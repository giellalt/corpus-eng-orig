...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/press-centre/press-releases/2012/770-million-to-cover-expenses-after-the-.html?id=682462'"/>
    ...
    <xsl:variable name="wordcount" select="'1247'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="770-millioner-kroner-til-utgifter-etter-_id_682462.html"/>
