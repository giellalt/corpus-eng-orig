...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization/Departments/The-Department-of-Civil-Affairs.html?id=1471'"/>
...
<xsl:variable name="para_nob" select="'sivilavdelingen.html?id=1471'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sivilavdelinga.html_id=1471" xml:lang="nno"/>
	<parallel_text location="sivilavdelingen.html_id=1471" xml:lang="nob"/>
	<parallel_text location="siviilaossodat-.html_id=1471" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
