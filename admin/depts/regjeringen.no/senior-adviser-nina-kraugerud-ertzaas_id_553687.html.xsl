...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-press-and-communications-division/-senior-adviser-nina-kraugerud-ertzaas.html?id=553687'"/>
...
<xsl:variable name="para_nob" select="'seniorradgiver-nina-kraugerud-ertzaas.html?id=553687'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seniorradgiver-nina-kraugerud-ertzaas.html_id=553687" xml:lang="nob"/>
	<parallel_text location="seniorraeaddi-nina-kraugerud-ertzaas.html_id=553687" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
