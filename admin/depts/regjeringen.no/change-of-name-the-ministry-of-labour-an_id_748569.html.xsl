...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/en/dep/asd/whats-new/news/2013/change-of-name-the-ministry-of-labour-an.html?id=748569'"/>
    ...
    <xsl:variable name="author1_ln" select="'Ministry of Labour and Social Affairs'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="departementet-skifter-navn_id_748569.html"/>
