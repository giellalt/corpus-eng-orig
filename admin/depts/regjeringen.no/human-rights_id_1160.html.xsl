...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/selected-topics/human-rights.html?id=1160'"/>
...
<xsl:variable name="para_nob" select="'menneskerettigheter.html?id=1160'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="menneskerettigheter.html_id=1160" xml:lang="nob"/>
	<parallel_text location="mr_samisk.html_id=1160" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
