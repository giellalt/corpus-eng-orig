...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Reforming-and-regenerating-the-public-se.html?id=1366'"/>
...
<xsl:variable name="para_nob" select="'fornying_av_offentlig_sektor.html?id=1366'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fornying_av_offentlig_sektor.html_id=1366" xml:lang="nob"/>
	<parallel_text location="almmola-suorggi-oasmahttin.html_id=1366" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
