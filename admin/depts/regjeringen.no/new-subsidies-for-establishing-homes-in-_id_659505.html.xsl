...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2011/new-subsidies-for-establishing-homes-in-.html?id=659505'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ođđa doarjja ássanviesuide boaittobeale guovlluin  - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'nytt-tilskot-for-bustadetablering-i-dist.html_id=659505'"/>
<xsl:variable name="para_nob" select="'regjeringen-prioriterer-utviklingen-av-d.html_id=659582'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oa-doarjja-assanviesuide-boaittobeale-gu.html_id=659505'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nytt-tilskot-for-bustadetablering-i-dist_id_659505.html" xml:lang="nno"/>
	<parallel_text location="" xml:lang="nob"/>
	<parallel_text location="oa-doarjja-assanviesuide-boaittobeale-gu_id_659505.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
