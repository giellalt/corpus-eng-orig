...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/topics/labour-market-policy/midtspalte/work-orientation.html?id=85996'"/>
...
<xsl:variable name="para_nob" select="'arbeidsretting.html?id=85996'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arbeidsretting.html_id=85996" xml:lang="nob"/>
	<parallel_text location="barguioauheapmi---.html_id=85996" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
