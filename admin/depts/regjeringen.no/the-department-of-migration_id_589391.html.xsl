...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization/Departments/the-department-of-migration.html?id=589391'"/>
...
<xsl:variable name="para_nob" select="'innvandringsavdelingen.html?id=589391'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="innvandringsavdelinga.html_id=589391" xml:lang="nno"/>
	<parallel_text location="innvandringsavdelingen.html_id=589391" xml:lang="nob"/>
	<parallel_text location="sisafarrenossodat-.html_id=589391" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
