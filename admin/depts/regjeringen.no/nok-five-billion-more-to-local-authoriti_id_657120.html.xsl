...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2011/nok-five-billion-more-to-local-authoriti.html?id=657120'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Vihtta miljárdda kruvnno eanet gielddaide 2012 - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'vihtta-miljardda-kruvnno-eanet-gielddaid.html_id=657120'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="komm-pressemelding-1-3.html_id=657120" xml:lang="nno"/>
	<parallel_text location="regjeringen-prioriterer-utviklingen-av-d.html_id=659582" xml:lang="nob"/>
	<parallel_text location="vihtta-miljardda-kruvnno-eanet-gielddaid.html_id=657120" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
