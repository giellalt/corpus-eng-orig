...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/primeminister/political-staff/state-secretary-dagfinn-sundsbo.html?id=582412'"/>
...
<xsl:variable name="para_nob" select="'statssekretar-dagfinn-sundsbo.html?id=582412'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statssekretar-dagfinn-sundsbo.html_id=582412" xml:lang="nob"/>
	<parallel_text location="stahtaalli-dagfinn-sundsbo.html_id=582412" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
