...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-regional-planning/deputy-director-general-jarle-jensen.html?id=85671'"/>
...
<xsl:variable name="para_nob" select="'jarle_jensen.html?id=85671'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jarle_jensen.html_id=85671" xml:lang="nob"/>
	<parallel_text location="ekspediuvdnahoavda-jarle-jensen.html_id=85671" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
