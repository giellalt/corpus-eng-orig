...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/Site-Map.html?id=313733'"/>
...
<xsl:variable name="para_nob" select="'nettstedskart.html?id=313733'"/>
