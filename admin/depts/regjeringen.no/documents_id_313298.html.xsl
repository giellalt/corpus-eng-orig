...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Documents.html?id=313298'"/>
...
<xsl:variable name="para_nob" select="'dok.html?id=313298'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dokument.html_id=313298" xml:lang="nno"/>
	<parallel_text location="dok.html_id=313298" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
