...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2010/More-rental-housing-for-people-in-difficulties.html?id=604481'"/>
<xsl:variable name="title" select="'Eanet láigoorrunsajit daidda guđet leat váttes dilis - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'RNB-Fleire-utleigebustader-til-vanskelegstilte.html?id=604481'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Eanet-laigoorrunsajit-daidda-guet-leat-vattes-dilis.html?id=604481'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rnb-fleire-utleigebustader-til-vanskelegstilte.html_id=604481" xml:lang="nno"/>
	<parallel_text location="eanet-laigoorrunsajit-daidda-guet-leat-vattes-dilis.html_id=604481" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
