...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-cultural-heritage-managem.html?id=1207'"/>
...
<xsl:variable name="para_nob" select="'kulturminneforvaltning.html?id=1207'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdeling-for-kulturminneforvaltning.html_id=1207" xml:lang="nno"/>
	<parallel_text location="kulturminneforvaltning.html_id=1207" xml:lang="nob"/>
	<parallel_text location="kulturmuitohalddaeami-ossodat.html_id=1207" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
