...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-organisational-and-econom/Section-for-Internal-Services-.html?id=85629'"/>
...
<xsl:variable name="para_nob" select="'internforvaltning.html?id=85629'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="internforvaltning.html_id=85629" xml:lang="nob"/>
	<parallel_text location="siskkaldashalddaansekuvdna.html_id=85629" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
