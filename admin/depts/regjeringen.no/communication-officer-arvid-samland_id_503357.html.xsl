...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/The-Office-of-the-Prime-Minister/Organisation/Departments/press-and-information-section/communication-officer-arvid-samland.html?id=503357'"/>
...
<xsl:variable name="para_nob" select="'kommunikasjonsradgiver-arvid-samland.html?id=503357'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kommunikasjonsradgjevar-arvid-samland.html_id=503357" xml:lang="nno"/>
	<parallel_text location="kommunikasjonsradgiver-arvid-samland.html_id=503357" xml:lang="nob"/>
	<parallel_text location="diehtojuohkinraeaddi-arvid-samland.html_id=503357" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
