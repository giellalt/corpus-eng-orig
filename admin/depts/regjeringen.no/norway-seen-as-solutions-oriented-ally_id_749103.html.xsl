...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/whats-new/News/2014/norway-seen-as-solutions-oriented-ally.html?id=749103'"/>
...
<xsl:variable name="para_nob" select="'-ser-pa-norge-som-en-losningsorientert-a.html_id=749103'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ser-pa-norge-som-en-losningsorientert-a.html_id=749103" xml:lang="nob"/>
	<parallel_text location="oaidna-norgga-ovdosiidda-rabas-lihtolaa.html_id=749103" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
