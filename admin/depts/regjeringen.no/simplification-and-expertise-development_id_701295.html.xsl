...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2012/simplification-and-expertise-development.html?id=701295'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Huksensuorggi álkkásmahttin ja gelbbolašvuođalokten - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'forenkling-og-kompetanseutvikling-i-bygg.html_id=701295'"/>
...
<xsl:variable name="para_sme" select="'huksensuorggi-alkkasmahttin-ja-gelbbolav.html_id=701295'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forenkling-og-kompetanseutvikling-i-bygg_id_701295.html" xml:lang="nno"/>
	<parallel_text location="huksensuorggi-alkkasmahttin-ja-gelbbolav_id_701295.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
