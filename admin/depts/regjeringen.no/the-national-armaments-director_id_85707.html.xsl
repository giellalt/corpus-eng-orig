...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/the-ministry/organisation/Departments/the-national-armaments-director.html?id=85707'"/>
...
<xsl:variable name="para_nob" select="'controllerenhet.html?id=85707'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="controllereining.html_id=85707" xml:lang="nno"/>
	<parallel_text location="controllerenhet.html_id=85707" xml:lang="nob"/>
	<parallel_text location="controller-ovttadat.html_id=85707" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
