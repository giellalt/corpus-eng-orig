...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/The-Financial-Markets-Department.html?id=1544'"/>
...
<xsl:variable name="para_nob" select="'finansavdelingen.html?id=1544'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="finansavdelinga.html_id=1544" xml:lang="nno"/>
	<parallel_text location="finansavdelingen.html_id=1544" xml:lang="nob"/>
	<parallel_text location="ruhtadanossodat.html_id=1544" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
