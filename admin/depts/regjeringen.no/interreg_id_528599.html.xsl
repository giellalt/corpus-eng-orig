...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/Subjects/rural-and-regional-policy/international-cooperation-on-rural-and-r/interreg.html?id=528599'"/>
...
<xsl:variable name="para_nob" select="'interreg-2.html?id=528599'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="interreg-2.html_id=528599" xml:lang="nob"/>
	<parallel_text location="oassalastin-eu-territoriala-ovttasbarggu.html_id=528599" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
