...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/press-center/press-releases/2013/amendments-to-the-2014-fiscal-budget.html?id=745264'"/>
...
<xsl:variable name="para_nob" select="'et-budsjett-for-verdiskaping-og-en-bedre.html_id=745264'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="et-budsjett-for-verdiskaping-og-en-bedre.html_id=745264" xml:lang="nob"/>
