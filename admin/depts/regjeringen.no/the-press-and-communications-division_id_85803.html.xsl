...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-press-and-communications-division.html?id=85803'"/>
...
<xsl:variable name="para_nob" select="'pks.html?id=85803'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="presse--og-kommunikasjonsseksjonen.html_id=85803" xml:lang="nno"/>
	<parallel_text location="pks.html_id=85803" xml:lang="nob"/>
	<parallel_text location="preassa--ja-gulahallansekuvdna-.html_id=85803" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
