...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/Other-political-staff.html?id=187'"/>
...
<xsl:variable name="para_nob" select="'politisk_ledelse.html?id=187'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="anna-politisk-leiing.html_id=187" xml:lang="nno"/>
	<parallel_text location="politisk_ledelse.html_id=187" xml:lang="nob"/>
	<parallel_text location="eara-politihkala-njunnoat.html_id=187" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
