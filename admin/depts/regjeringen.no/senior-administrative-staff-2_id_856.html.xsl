...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/senior-administrative-staff-2.html?id=856'"/>
...
<xsl:variable name="para_nob" select="'administrativ_ledelse.html?id=856'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="admnistrativ-leiing.html_id=856" xml:lang="nno"/>
	<parallel_text location="administrativ_ledelse.html_id=856" xml:lang="nob"/>
	<parallel_text location="halddahusla-njunugodd.html_id=856" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
