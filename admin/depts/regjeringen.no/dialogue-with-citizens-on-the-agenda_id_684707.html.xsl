...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new/news/2012/dialogue-with-citizens-on-the-agenda.html?id=684707'"/>
...
<xsl:variable name="para_nob" select="'diskuterte-innbyggerdialog.html_id=684707'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="diskuterte-innbyggerdialog.html_id=684707" xml:lang="nob"/>
	<parallel_text location="divatallat-assiidgulahallama-birra-.html_id=684707" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
