...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/audun-lysbakken.html?id=582256'"/>
...
<xsl:variable name="para_nob" select="'barne--og-likestillingsminister-audun-ly.html?id=582256'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="barne--likestillings--og-inkluderingsmin.html_id=582256" xml:lang="nno"/>
	<parallel_text location="barne--og-likestillingsminister-audun-ly.html_id=582256" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
