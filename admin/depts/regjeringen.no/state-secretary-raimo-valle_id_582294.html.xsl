...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Other-political-staff/state-secretary-raimo-valle.html?id=582294'"/>
...
<xsl:variable name="para_nob" select="'statssekretar-raimo-valle.html?id=582294'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statssekretar-raimo-valle.html_id=582294" xml:lang="nob"/>
	<parallel_text location="stahtaalli-raimo-valle.html_id=582294" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
