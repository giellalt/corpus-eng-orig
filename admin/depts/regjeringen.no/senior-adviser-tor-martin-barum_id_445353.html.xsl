...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/information-department/Senior-Adviser-Tor-MArtin-Barum.html?id=445353'"/>
...
<xsl:variable name="para_nob" select="'tor-martin-barum.html?id=445353'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seniorradgivar-tor-martin-barum.html_id=445353" xml:lang="nno"/>
	<parallel_text location="tor-martin-barum.html_id=445353" xml:lang="nob"/>
	<parallel_text location="seniorraeaddi-tor-martin-barum.html_id=445353" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
