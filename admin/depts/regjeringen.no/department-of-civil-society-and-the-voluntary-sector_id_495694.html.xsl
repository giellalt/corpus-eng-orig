...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/Organisation/Departments/Department-of-Civil-Society-and-the-Voluntary-Sector.html?id=495694'"/>
...
<xsl:variable name="para_nob" select="'samfunns_og_frivillighetsavdelingen.html?id=495694'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samfunns--og-frivillighetsavdelinga.html_id=495694" xml:lang="nno"/>
	<parallel_text location="samfunns_og_frivillighetsavdelingen.html_id=495694" xml:lang="nob"/>
	<parallel_text location="servodat--ja-eaktodahtolaossodaga.html_id=495694" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
