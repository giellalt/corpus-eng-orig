...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/press-and-information-unit.html?id=85684'"/>
...
<xsl:variable name="para_nob" select="'kommunikasjonsenheten.html?id=85684'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kommunikasjonsenheten.html_id=85684" xml:lang="nob"/>
	<parallel_text location="preassa--ja-diehtojuohkinossodat.html_id=85684" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
