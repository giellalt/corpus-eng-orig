...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/topics/pensions/disability-pension.html?id=9462'"/>
...
<xsl:variable name="para_nob" select="'uforepensjon.html?id=9462'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="uforepensjon_id_9462.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
