...
<xsl:variable name="filename" select="'http://regjeringen.no/en/Topics_a-z.html?id=223486'"/>
...
<xsl:variable name="para_nob" select="'tema_a-aa.html?id=223486'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tema_a-aa.html_id=223486" xml:lang="nno"/>
	<parallel_text location="tema_a-aa.html_id=223486" xml:lang="nob"/>
	<parallel_text location="fadda_a-aa.html_id=223486" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
