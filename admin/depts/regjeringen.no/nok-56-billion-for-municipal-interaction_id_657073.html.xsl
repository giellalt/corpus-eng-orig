...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2011/nok-56-billion-for-municipal-interaction.html?id=657073'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'5,6 miljárdda kruvnno gielddaid ovttasdoaibmamii - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'komm-pressemelding-1-2.html_id=657073'"/>
<xsl:variable name="para_nob" select="'regjeringen-prioriterer-utviklingen-av-d.html_id=659582'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'56-miljardda-kruvnno-gielddaid-ovttasdoa.html_id=657073'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="komm-pressemelding-1-2_id_657073.html" xml:lang="nno"/>
	<parallel_text location="regjeringen-prioriterer-utviklingen-av-d_id_659582.html" xml:lang="nob"/>
	<parallel_text location="56-miljardda-kruvnno-gielddaid-ovttasdoa_id_657073.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
