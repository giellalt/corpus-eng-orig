...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/press-centre/Press-releases/2012/new-directorate-environment.html?id=707555'"/>
...
<xsl:variable name="para_nob" select="'regjeringen-etablerer-miljodirektorat.html_id=707555'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringen-etablerer-miljodirektorat.html_id=707555" xml:lang="nob"/>
	<parallel_text location="raehus-asaha-birasdirektorahta.html_id=707555" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
