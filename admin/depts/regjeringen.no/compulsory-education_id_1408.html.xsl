...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/compulsory-education.html?id=1408'"/>
...
<xsl:variable name="para_nob" select="'grunnopplaring.html?id=1408'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="grunnopplaring.html_id=1408" xml:lang="nob"/>
	<parallel_text location="vuooskuvla.html_id=1408" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
