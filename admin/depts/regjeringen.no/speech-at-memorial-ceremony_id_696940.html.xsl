...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new/Speeches-and-articles/statsministeren/statsminister_jens_stoltenberg/2012/speech-at-memorial-ceremony.html?id=696940'"/>
...
<xsl:variable name="para_nob" select="'speech-at-the-ceremony-in-the-government.html_id=696940'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="speech-at-the-ceremony-in-the-government.html_id=696940" xml:lang="nob"/>
	<parallel_text location="sardni-kransabidjamis.html_id=696940" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
