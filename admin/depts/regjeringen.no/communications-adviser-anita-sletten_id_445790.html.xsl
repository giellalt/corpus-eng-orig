...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-press-and-communications-division/communications-adviser-anita-sletten.html?id=445790'"/>
...
<xsl:variable name="para_nob" select="'anita-sletten.html?id=445790'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="anita-sletten.html_id=445790" xml:lang="nob"/>
	<parallel_text location="gulahallanraeaddi-anita-sletten.html_id=445790" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
