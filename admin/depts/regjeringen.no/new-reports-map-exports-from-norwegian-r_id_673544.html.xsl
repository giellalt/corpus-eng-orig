...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2012/new-reports-map-exports-from-norwegian-r.html?id=673544'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ođđa raporta lea guorahallan vuovdimiid olgoriikii buot guovlluin Norggas  - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'ny-rapport-har-kartlagt-eksporten-fra-no.html_id=673544'"/>
<xsl:variable name="para_nob" select="'mangel-pa-samisk-larere-og-laremidler.html_id=673673'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oa-raporta-lea-guorahallan-vuovdimiid-ol.html_id=673544'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ny-rapport-har-kartlagt-eksporten-fra-no.html_id=673544" xml:lang="nno"/>
	<parallel_text location="mangel-pa-samisk-larere-og-laremidler.html_id=673673" xml:lang="nob"/>
	<parallel_text location="oa-raporta-lea-guorahallan-vuovdimiid-ol.html_id=673544" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
