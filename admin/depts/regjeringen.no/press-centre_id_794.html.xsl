...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/press-centre.html?id=794'"/>
...
<xsl:variable name="para_nob" select="'pressesenter.html?id=794'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pressesenter.html_id=794" xml:lang="nno"/>
	<parallel_text location="pressesenter.html_id=794" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
