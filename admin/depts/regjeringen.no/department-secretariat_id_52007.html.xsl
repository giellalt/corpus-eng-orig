...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-nature-management/Department-Secretariat.html?id=52007'"/>
...
<xsl:variable name="para_nob" select="'avdelingssekretariatet.html?id=52007'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdelingssekretariatet.html_id=52007" xml:lang="nob"/>
	<parallel_text location="ossodatallingoddi.html_id=52007" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
