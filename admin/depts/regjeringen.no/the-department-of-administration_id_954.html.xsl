...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-department-of-administration.html?id=954'"/>
...
<xsl:variable name="para_nob" select="'aua.html?id=954'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="administrasjons--og-utviklingsavdelinga.html_id=954" xml:lang="nno"/>
	<parallel_text location="aua.html_id=954" xml:lang="nob"/>
	<parallel_text location="halddahus--ja-bueahttaossodat-.html_id=954" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
