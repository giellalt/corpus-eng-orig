...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/press-centre/press-releases/2011/food-power-and-impotence.html?id=640269'"/>
...
<xsl:variable name="para_nob" select="'mat-makt-og-avmakt.html_id=640269'"/>
