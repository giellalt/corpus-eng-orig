...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2012/nok-27-billion-allocated-to-local-and-re.html?id=701135'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'2,7 miljárdda kruvnnu biire- ja guovllupolitihkkii - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'696'"/>
...
<xsl:variable name="para_nno" select="'27-milliardar-kroner-til-distrikts--og-r.html_id=701135'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="27-milliardar-kroner-til-distrikts--og-r_id_701135.html" xml:lang="nno"/>
	<parallel_text location="27-miljardda-kruvnnu-biire--ja-guovllupo_id_701135.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
