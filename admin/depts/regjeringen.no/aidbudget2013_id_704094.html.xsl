...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/press/news/2012/aidbudget2013.html?id=704094'"/>
...
<xsl:variable name="para_nob" select="'bistandsbudsjett-doblet.html_id=704094'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bistandsbudsjett-doblet.html_id=704094" xml:lang="nob"/>
	<parallel_text location="ovddidanbuseahta.html_id=704094" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
