...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed/press-center/Press-releases/2008/announcement--20th-licensing-round.html?id=519885'"/>
...
<xsl:variable name="para_nob" select="'utlysning-av-20-konsesjonsrunde.html?id=519885'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utlysning-av-20-konsesjonsrunde.html_id=519885" xml:lang="nob"/>
	<parallel_text location="almmuhus---20-konseuvdnavuorru-.html_id=519885" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
