...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/Documents/Guidelines-and-brochures.html?id=2134'"/>
...
<xsl:variable name="para_nob" select="'veiledninger_og_brosjyrer.html?id=2134'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rettleiingar-og-brosjyrar.html_id=2134" xml:lang="nno"/>
	<parallel_text location="veiledninger_og_brosjyrer.html_id=2134" xml:lang="nob"/>
	<parallel_text location="bagadusat-ja-gihppagat.html_id=2134" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
