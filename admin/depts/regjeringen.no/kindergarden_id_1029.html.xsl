...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/kindergarden.html?id=1029'"/>
...
<xsl:variable name="para_nob" select="'barnehager.html?id=1029'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="barnehager.html_id=1029" xml:lang="nob"/>
	<parallel_text location="manaidgarddit.html_id=1029" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
