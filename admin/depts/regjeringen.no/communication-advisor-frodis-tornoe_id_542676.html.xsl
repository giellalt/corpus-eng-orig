...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments/department-of-information-and-communicat/communication-advisor-frodis-tornoe.html?id=542676'"/>
...
<xsl:variable name="para_nob" select="'kommunikasjonsradgiver.html?id=542676'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kommunikasjonsradgjevar-froydis-tornoe.html_id=542676" xml:lang="nno"/>
	<parallel_text location="kommunikasjonsradgiver.html_id=542676" xml:lang="nob"/>
	<parallel_text location="gulahalliraeaddi-frodis-tornoe.html_id=542676" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
