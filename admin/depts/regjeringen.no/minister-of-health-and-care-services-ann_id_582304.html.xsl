...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/About-the-Ministry/minister-of-health-and-care-services-ann.html?id=582304'"/>
...
<xsl:variable name="para_nob" select="'helse--og-omsorgsminister-anne-grete-str.html?id=582304'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="helse--og-omsorgsminister-anne-grete-str.html_id=582304" xml:lang="nno"/>
	<parallel_text location="helse--og-omsorgsminister-anne-grete-str.html_id=582304" xml:lang="nob"/>
	<parallel_text location="dearvvavuoa--ja-fuolahusministtar-anne-g.html_id=582304" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
