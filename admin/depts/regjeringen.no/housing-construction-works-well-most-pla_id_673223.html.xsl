...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2012/housing-construction-works-well-most-pla.html?id=673223'"/>
...
<xsl:variable name="para_nob" select="'bustadbygginga-fungerer-godt-dei-fleste-.html_id=673223'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bustadbygginga-fungerer-godt-dei-fleste-.html_id=673223" xml:lang="nob"/>
	<parallel_text location="viessohuksemat-ovdanit-bures-eana-baikki.html_id=673223" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
