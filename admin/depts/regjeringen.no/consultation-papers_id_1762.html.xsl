...
<xsl:variable name="filename" select="'http://regjeringen.no/en/doc/consultation-papers.html?id=1762'"/>
...
<xsl:variable name="para_nob" select="'rundskriv.html?id=1762'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rundskriv.html_id=1762" xml:lang="nno"/>
	<parallel_text location="rundskriv.html_id=1762" xml:lang="nob"/>
	<parallel_text location="johtoallosat-.html_id=1762" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
