...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/department-of-ict-policy-and-public-sect.html?id=1589'"/>
...
<xsl:variable name="para_nob" select="'it-politisk_avdeling.html?id=1589'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="it-politisk_avdeling.html_id=1589" xml:lang="nob"/>
	<parallel_text location="it-politihkala-ossodat.html_id=1589" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
