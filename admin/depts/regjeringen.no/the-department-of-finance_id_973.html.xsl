...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-department-of-finance.html?id=973'"/>
...
<xsl:variable name="para_nob" select="'boa.html?id=973'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="budsjett--og-okonomiavdelinga.html_id=973" xml:lang="nno"/>
	<parallel_text location="boa.html_id=973" xml:lang="nob"/>
	<parallel_text location="bueahtta--ja-ekonomiijaossodat--.html_id=973" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
