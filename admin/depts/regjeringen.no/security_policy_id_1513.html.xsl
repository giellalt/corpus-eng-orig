...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/security_policy.html?id=1513'"/>
...
<xsl:variable name="para_nob" select="'avdeling_for_sikkerhetspolitikk.html?id=1513'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdeling_for_sikkerhetspolitikk.html_id=1513" xml:lang="nob"/>
	<parallel_text location="sihkkarvuoa-ja-lagaguovlluid-ossodat.html_id=1513" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
