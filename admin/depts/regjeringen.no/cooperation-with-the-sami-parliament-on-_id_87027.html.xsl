...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/international-efforts-in-relation-to-ind/cooperation-with-the-sami-parliament-on-.html?id=87027'"/>
...
<xsl:variable name="para_nob" select="'samarbeid-med-sametinget-i-internasjonal.html?id=87027'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samarbeid-med-sametinget-i-internasjonal.html_id=87027" xml:lang="nob"/>
	<parallel_text location="ovttasbargu-samedikkiin-riikkaidgaskasa-.html_id=87027" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
