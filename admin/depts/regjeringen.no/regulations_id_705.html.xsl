...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/documents-and-publications/acts-and-regulations/regulations.html?id=705'"/>
...
<xsl:variable name="para_nob" select="'forskrifter.html?id=705'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrifter.html_id=705" xml:lang="nno"/>
	<parallel_text location="forskrifter.html_id=705" xml:lang="nob"/>
	<parallel_text location="lahkaasahusat.html_id=705" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
