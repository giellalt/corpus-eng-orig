...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/Organisation/Departments/The-Communication-Unit/senior-adviser-sissel-mossing.html?id=446503'"/>
...
<xsl:variable name="para_nob" select="'sim.html?id=446503'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sim.html_id=446503" xml:lang="nob"/>
	<parallel_text location="seniorraeaddi-sissel-mossing.html_id=446503" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
