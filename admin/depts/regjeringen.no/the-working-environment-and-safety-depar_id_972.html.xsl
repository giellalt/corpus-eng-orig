...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-working-environment-and-safety-depar.html?id=972'"/>
...
<xsl:variable name="para_nob" select="'ams.html?id=972'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arbeidsmiljo--og-sikkerheitsavdelinga.html_id=972" xml:lang="nno"/>
	<parallel_text location="ams.html_id=972" xml:lang="nob"/>
	<parallel_text location="bargobiras--ja-sihkkarvuoaossodat-.html_id=972" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
