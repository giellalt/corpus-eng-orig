...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/Documents/Acts-and-regulations/Acts.html?id=663'"/>
...
<xsl:variable name="para_nob" select="'lover.html?id=663'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lover.html_id=663" xml:lang="nno"/>
	<parallel_text location="lover.html_id=663" xml:lang="nob"/>
	<parallel_text location="lagat-.html_id=663" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
