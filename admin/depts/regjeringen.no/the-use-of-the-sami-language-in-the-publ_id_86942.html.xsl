...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/use-of-the-sami-languages/the-use-of-the-sami-language-in-the-publ.html?id=86942'"/>
...
<xsl:variable name="para_nob" select="'bruk-av-samisk-sprak-i-offentlig-forvalt.html?id=86942'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bruk-av-samisk-sprak-i-offentlig-forvalt.html_id=86942" xml:lang="nob"/>
	<parallel_text location="samegiela-geavaheapmi-almmola-halddahusa.html_id=86942" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
