...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/press-centre/press-releases/2013/recommend-demolition-of-the-damaged-buil.html?id=731758'"/>
...
<xsl:variable name="para_nob" select="'utredere-foreslar-a-rive-de-skadde-regje.html_id=731758'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="900-000-kroner-til-ny-giv-i-karasjok_id_731701.html" xml:lang="nno"/>
	<parallel_text location="utredere-foreslar-a-rive-de-skadde-regje_id_731758.html" xml:lang="nob"/>
