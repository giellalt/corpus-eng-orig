...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new/Speeches-and-articles/statsministeren/statsminister_jens_stoltenberg/2011/prime-minister-jens-stoltenbergs-new-yea.html?id=629901'"/>
...
<xsl:variable name="para_nob" select="'statsministerens-nyttarstale-2011.html?id=629901'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="statsministerens-nyttarstale-2011.html_id=629901" xml:lang="nob"/>
	<parallel_text location="stahtaministara-oajagesardni-jagi-2010.html_id=629901" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
