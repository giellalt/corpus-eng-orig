...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments.html?id=366'"/>
...
<xsl:variable name="para_nob" select="'avdelinger.html?id=366'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdelingar.html_id=366" xml:lang="nno"/>
	<parallel_text location="avdelinger.html_id=366" xml:lang="nob"/>
	<parallel_text location="ossodagat.html_id=366" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
