...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2009/climate-change-and-afghanistan-topics-at.html?id=588197'"/>
...
<xsl:variable name="para_nob" select="'klima-og-afghanistan-sentrale-tema-i-sto.html?id=588197'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="klima-og-afghanistan-sentrale-tema-i-sto.html_id=588197" xml:lang="nob"/>
	<parallel_text location="dalkkadat-ja-afghanistana-ledje-guovdili.html_id=588197" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
