...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/press/news/2012/affordable_medicine.html?id=701312'"/>
...
<xsl:variable name="para_nob" select="'satsing_gavi.html_id=701312'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="satsing_gavi.html_id=701312" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
