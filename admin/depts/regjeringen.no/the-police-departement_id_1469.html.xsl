...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization/Departments/the-police-departement.html?id=1469'"/>
...
<xsl:variable name="para_nob" select="'politiavdelingen.html?id=1469'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="politiavdelinga.html_id=1469" xml:lang="nno"/>
	<parallel_text location="politiavdelingen.html_id=1469" xml:lang="nob"/>
	<parallel_text location="politiijaossodat-.html_id=1469" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
