...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/info_unit/trv.html?id=445146'"/>
...
<xsl:variable name="para_nob" select="'infosjef.html?id=445146'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="infosjef.html_id=445146" xml:lang="nob"/>
	<parallel_text location="diehtojuohkinhoavda.html_id=445146" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
