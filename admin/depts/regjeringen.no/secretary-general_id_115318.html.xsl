...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Senior-administrative-staff/Secretary-General.html?id=115318'"/>
...
<xsl:variable name="para_nob" select="'departementsrad.html?id=115318'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="departementsrad.html_id=115318" xml:lang="nob"/>
	<parallel_text location="departemeantarai-jorn-krog.html_id=115318" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
