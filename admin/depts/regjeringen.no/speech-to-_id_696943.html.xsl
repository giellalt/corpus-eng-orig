...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new/Speeches-and-articles/statsministeren/statsminister_jens_stoltenberg/2012/speech-to-.html?id=696943'"/>
...
<xsl:variable name="para_nob" select="'tale-ved-samling-for-etterlatte-parorend.html_id=696943'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tale-ved-samling-for-etterlatte-parorend.html_id=696943" xml:lang="nob"/>
	<parallel_text location="sardni-oamehasaide-ja-eaktodahtolaaide.html_id=696943" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
