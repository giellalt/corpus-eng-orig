...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/the-department-of-sami-and-minority-affa.html?id=589401'"/>
...
<xsl:variable name="para_nob" select="'same--og-minoritetspolitisk-avdeling.html?id=589401'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="same--og-minoritetspolitisk-avdeling.html_id=589401" xml:lang="nno"/>
	<parallel_text location="same--og-minoritetspolitisk-avdeling.html_id=589401" xml:lang="nob"/>
	<parallel_text location="same--og-minoritetspolitisk-avdeling.html_id=589401" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
