...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/reg.html?id=1517'"/>
...
<xsl:variable name="para_nob" select="'regavdelingen.html?id=1517'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regavdelingen.html_id=1517" xml:lang="nob"/>
	<parallel_text location="regionala-gaaldagaid-ja-ovdaneami-ossodat.html_id=1517" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
