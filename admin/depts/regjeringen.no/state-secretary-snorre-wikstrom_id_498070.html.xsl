...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/primeminister/political-staff/state-secretary-snorre-wikstrom.html?id=498070'"/>
...
<xsl:variable name="para_nob" select="'statssekretar-snorre-wikstrom.html?id=498070'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statssekretar-snorre-wikstrom.html_id=498070" xml:lang="nob"/>
	<parallel_text location="stahtaalli-snorre-wikstrom.html_id=498070" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
