...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/midtspalte/division-of-responsibility-and-coordinat.html?id=86932'"/>
...
<xsl:variable name="para_nob" select="'ansvarsfordeling-og-samordning.html?id=86932'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ansvarsfordeling-og-samordning.html_id=86932" xml:lang="nob"/>
	<parallel_text location="ovddasvastadusjuohku-ja-oktiiordnen.html_id=86932" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
