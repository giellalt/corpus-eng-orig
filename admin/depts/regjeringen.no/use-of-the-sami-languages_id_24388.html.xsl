...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/use-of-the-sami-languages.html?id=24388'"/>
...
<xsl:variable name="para_nob" select="'bruk_av_samisk_sprak.html?id=24388'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bruk_av_samisk_sprak.html_id=24388" xml:lang="nob"/>
