...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/minister-of-reform-and-church-affairs-ri.html?id=582206'"/>
...
<xsl:variable name="para_nob" select="'fornyings--og-administrasjonsminister-ri.html?id=582206'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fornyings--og-kyrkjeminister-rigmor-aasr.html_id=582206" xml:lang="nno"/>
	<parallel_text location="fornyings--og-administrasjonsminister-ri.html_id=582206" xml:lang="nob"/>
	<parallel_text location="oasmahttin--ja-girkoministtar-rigmor-aas.html_id=582206" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
