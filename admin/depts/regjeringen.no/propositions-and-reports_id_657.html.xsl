...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/Documents/propositions-and-reports.html?id=657'"/>
...
<xsl:variable name="para_nob" select="'regpubl.html?id=657'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="proposisjonar-og-meldingar.html_id=657" xml:lang="nno"/>
	<parallel_text location="regpubl.html_id=657" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
