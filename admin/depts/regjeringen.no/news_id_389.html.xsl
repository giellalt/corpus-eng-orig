...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/whats-new/News.html?id=389'"/>
...
<xsl:variable name="para_nob" select="'nyheter.html?id=389'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nyheiter.html_id=389" xml:lang="nno"/>
	<parallel_text location="nyheter.html_id=389" xml:lang="nob"/>
	<parallel_text location="oasat.html_id=389" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
