...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Other-political-staff/State-Secretary-Terje-Moland-Pedersen.html?id=1695'"/>
...
<xsl:variable name="para_nob" select="'statssekretar_terje_moland_pedersen.html?id=1695'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statssekretar-terje-moland-pedersen.html_id=1695" xml:lang="nno"/>
	<parallel_text location="statssekretar_terje_moland_pedersen.html_id=1695" xml:lang="nob"/>
	<parallel_text location="stahtaalli-terje-moland-pedersen.html_id=1695" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
