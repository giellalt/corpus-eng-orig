...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments.html?id=284'"/>
...
<xsl:variable name="para_nob" select="'avdelinger.html?id=284'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdelingar.html_id=284" xml:lang="nno"/>
	<parallel_text location="avdelinger.html_id=284" xml:lang="nob"/>
	<parallel_text location="departemeantta-ossodagat.html_id=284" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
