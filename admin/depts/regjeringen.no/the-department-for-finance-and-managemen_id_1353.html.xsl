...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/the-ministry/organisation/Departments/the-department-for-finance-and-managemen.html?id=1353'"/>
...
<xsl:variable name="para_nob" select="'avdeling_for_okonomi_og_styring.html?id=1353'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdeling-for-okonomi-og-styring.html_id=1353" xml:lang="nno"/>
	<parallel_text location="avdeling_for_okonomi_og_styring.html_id=1353" xml:lang="nob"/>
	<parallel_text location="ekonomiija--ja-stivrenossodat.html_id=1353" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
