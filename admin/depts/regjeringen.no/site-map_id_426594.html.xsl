...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Site-Map.html?id=426594'"/>
...
<xsl:variable name="para_nob" select="'nettstedskart.html?id=426594'"/>
