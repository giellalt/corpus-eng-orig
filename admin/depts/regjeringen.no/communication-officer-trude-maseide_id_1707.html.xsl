...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/The-Office-of-the-Prime-Minister/Organisation/Departments/press-and-information-section/Communication-Officer-Trude-Maseide.html?id=1707'"/>
...
<xsl:variable name="para_nob" select="'trude_maseide.html?id=1707'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="trude_maseide.html_id=1707" xml:lang="nob"/>
	<parallel_text location="kommunikasjonsradgiver-trude-maseide.html_id=1707" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
