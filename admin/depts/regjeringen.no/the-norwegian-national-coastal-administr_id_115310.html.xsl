...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Subordinate-agencies-and-institutions/the-norwegian-national-coastal-administr.html?id=115310'"/>
...
<xsl:variable name="para_nob" select="'kystverket.html?id=115310'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kystverket.html_id=115310" xml:lang="nno"/>
	<parallel_text location="kystverket.html_id=115310" xml:lang="nob"/>
	<parallel_text location="riddodoaimmahat-kystverket.html_id=115310" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
