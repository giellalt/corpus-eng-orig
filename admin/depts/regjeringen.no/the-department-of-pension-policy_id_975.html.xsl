...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-department-of-pension-policy.html?id=975'"/>
...
<xsl:variable name="para_nob" select="'pa.html?id=975'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pensjonsavdelinga.html_id=975" xml:lang="nno"/>
	<parallel_text location="pa.html_id=975" xml:lang="nob"/>
	<parallel_text location="ealahatossodat.html_id=975" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
