...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/Tax_Policy_Department.html?id=1547'"/>
...
<xsl:variable name="para_nob" select="'skatteokonomisk_avdeling.html?id=1547'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skatteokonomisk-avdeling.html_id=1547" xml:lang="nno"/>
	<parallel_text location="skatteokonomisk_avdeling.html_id=1547" xml:lang="nob"/>
	<parallel_text location="vearroekonomala-ossodat-.html_id=1547" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
