...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/dok/lover_regler/lover.html?id=540'"/>
...
<xsl:variable name="para_nob" select="'lover_regler.html?id=272526'"/>
