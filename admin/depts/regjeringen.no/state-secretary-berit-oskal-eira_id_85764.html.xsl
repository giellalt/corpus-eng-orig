...
<xsl:variable name="filename" select="'http://regjeringen.no/en/archive/Stoltenbergs-2nd-Government/Ministry-of-Labour-and-Social-Inclusion/andre-dokumenter/personer/2005/State-Secretary-Berit-Oskal-Eira.html?id=85764'"/>
...
<xsl:variable name="para_nob" select="'statssekretar_berit_oskal_eira.html?id=85764'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statssekretar_berit_oskal_eira.html_id=85764" xml:lang="nob"/>
	<parallel_text location="stahtaalli-berit-oskal-eira.html_id=85764" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
