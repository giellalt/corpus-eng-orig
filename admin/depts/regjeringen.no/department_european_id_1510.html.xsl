...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/department_european.html?id=1510'"/>
...
<xsl:variable name="para_nob" select="'europaavdelingen.html?id=1510'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="europaavdelingen.html_id=1510" xml:lang="nob"/>
	<parallel_text location="eurohpa-ja-gavpeossodat.html_id=1510" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
