...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments/department-of-information-and-communicat/Communication-Advisor.html?id=439360'"/>
...
<xsl:variable name="para_nob" select="'kommunikasjonsradgiver-karin-johansen.html?id=439360'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kommunikasjonsradgjevar-karin-johansen.html_id=439360" xml:lang="nno"/>
	<parallel_text location="kommunikasjonsradgiver-karin-johansen.html_id=439360" xml:lang="nob"/>
	<parallel_text location="diehtojuohkinraeaddi.html_id=439360" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
