...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-regional-planning/land-use-policy-municipal-planning.html?id=85670'"/>
...
<xsl:variable name="para_nob" select="'arealpolitikk-og-planforvaltning.html?id=85670'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arealpolitikk-og-planforvaltning.html_id=85670" xml:lang="nob"/>
	<parallel_text location="suohkana-arealplanema-sekuvdna.html_id=85670" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
