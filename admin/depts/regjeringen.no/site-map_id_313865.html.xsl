...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/nhd/Site-Map.html?id=313865'"/>
...
<xsl:variable name="para_nob" select="'nettstedskart.html?id=313865'"/>
