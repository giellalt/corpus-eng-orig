...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2012/a-pro-active-and-forward-looking-housing.html?id=701294'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Áigeguovdilis ja boahtteáigái heivehuvvon viessopolitihkka - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'ein-offensiv-og-framtidsretta-bustadpoli.html_id=701294'"/>
...
<xsl:variable name="para_sme" select="'aigeguovdilis-ja-boahtteaigai-heivehuvvo.html_id=701294'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ein-offensiv-og-framtidsretta-bustadpoli.html_id=701294" xml:lang="nno"/>
	<parallel_text location="aigeguovdilis-ja-boahtteaigai-heivehuvvo.html_id=701294" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
