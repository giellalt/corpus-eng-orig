...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/organisation/departments/Department-of-Consumer-Affairs.html?id=83'"/>
...
<xsl:variable name="para_nob" select="'for.html?id=83'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forbrukaravdelinga.html_id=83" xml:lang="nno"/>
	<parallel_text location="for.html_id=83" xml:lang="nob"/>
	<parallel_text location="golaheaddjiossodat.html_id=83" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
