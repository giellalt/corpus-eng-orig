...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/Press-Centre/Press-releases.html?id=276'"/>
...
<xsl:variable name="para_nob" select="'pressemeldinger.html?id=276'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pressemeldingar.html_id=276" xml:lang="nno"/>
	<parallel_text location="pressemeldinger.html_id=276" xml:lang="nob"/>
	<parallel_text location="preassadieahusat.html_id=276" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
