...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Civil-protection-and-defence/Terrorism.html?id=1114'"/>
...
<xsl:variable name="para_nob" select="'terrorisme.html?id=1114'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="terrorisme.html_id=1114" xml:lang="nno"/>
	<parallel_text location="terrorisme.html_id=1114" xml:lang="nob"/>
	<parallel_text location="terrorisma.html_id=1114" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
