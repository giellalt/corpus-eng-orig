...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/press-center/pressemeldinger/20131/agustawestland-awarded-contract.html?id=747342'"/>
...
<xsl:variable name="para_nob" select="'agustawestland-tildelt-kontrakt-om-lever.html_id=747342'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="agustawestland-tildelt-kontrakt-om-lever.html_id=747342" xml:lang="nob"/>
	<parallel_text location="agustawestland-lea-oon-falaldaga-skahput.html_id=747342" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
