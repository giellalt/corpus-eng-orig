...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/financial_markets_department.html?id=1551'"/>
...
<xsl:variable name="para_nob" select="'finansmarkedsavdelingen.html?id=1551'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="finansmarknadsavdelinga.html_id=1551" xml:lang="nno"/>
	<parallel_text location="finansmarkedsavdelingen.html_id=1551" xml:lang="nob"/>
	<parallel_text location="ruhtadanmarkanossodat.html_id=1551" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
