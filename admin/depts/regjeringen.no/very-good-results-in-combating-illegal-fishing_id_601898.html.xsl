...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/Press-Centre/Press-releases/2010/Very-good-results-in-combating-illegal-fishing.html?id=601898'"/>
...
<xsl:variable name="para_nob" select="'Svart-gode-resultater-i-kampen-mot-ulovlig-fiske.html?id=601898'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="svart-gode-resultater-i-kampen-mot-ulovlig-fiske.html_id=601898" xml:lang="nob"/>
	<parallel_text location="hui-buorit-bohtosat-lobihis-guolasteami-vuostalastimis.html_id=601898" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
