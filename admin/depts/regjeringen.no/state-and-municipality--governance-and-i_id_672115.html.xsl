...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2012/state-and-municipality--governance-and-i.html?id=672115'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Stáhta ja gielddat – stivrejupmi ja ovttasdoaibman: - Gielddat dárbbašit friddjavuođa - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'stat-og-kommune--styring-og-samspel.html_id=672115'"/>
...
<xsl:variable name="para_sme" select="'stahta-ja-gielddat--stivrejupmi-ja-ovtta.html_id=672115'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stat-og-kommune--styring-og-samspel.html_id=672115" xml:lang="nno"/>
	<parallel_text location="stahta-ja-gielddat--stivrejupmi-ja-ovtta.html_id=672115" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
