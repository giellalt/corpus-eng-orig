...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/topics/labour-market-policy/midtspalte/rehabilitation.html?id=85997'"/>
...
<xsl:variable name="para_nob" select="'rehabilitering.html?id=85997'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rehabilitering.html_id=85997" xml:lang="nob"/>
	<parallel_text location="doaimmaidahttin-.html_id=85997" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
