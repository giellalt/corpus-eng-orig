...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-regional-planning/environmental-assessment-community-devel.html?id=85672'"/>
...
<xsl:variable name="para_nob" select="'miljo-og-samfunnsutvikling.html?id=85672'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="miljo-og-samfunnsutvikling.html_id=85672" xml:lang="nob"/>
	<parallel_text location="birasielggadansekuvdna.html_id=85672" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
