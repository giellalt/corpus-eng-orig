...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/nhd/about-the-ministry/organisation/Departments/ownership-department.html?id=1522'"/>
...
<xsl:variable name="para_nob" select="'eierskapsavdelingen.html?id=1522'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="eierskapsavdelingen.html_id=1522" xml:lang="nob"/>
	<parallel_text location="eaiggaduanossodat-.html_id=1522" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
