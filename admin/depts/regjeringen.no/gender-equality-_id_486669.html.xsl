...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/gender-equality-.html?id=486669'"/>
...
<xsl:variable name="para_nob" select="'likestilling-i-barnehage-utdanning-og-fo.html?id=486669'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="likestilling-i-barnehage-utdanning-og-fo.html_id=486669" xml:lang="nob"/>
	<parallel_text location="dassearvu-manaidgarddis-oahpahusas-ja-du.html_id=486669" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
