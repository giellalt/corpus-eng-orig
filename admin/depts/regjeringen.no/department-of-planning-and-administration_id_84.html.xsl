...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/organisation/departments/Department-of-Planning-and-Administration.html?id=84'"/>
...
<xsl:variable name="para_nob" select="'pla.html?id=84'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="plan--og-administrasjonsavdelinga-.html_id=84" xml:lang="nno"/>
	<parallel_text location="pla.html_id=84" xml:lang="nob"/>
	<parallel_text location="plana--ja-halddahusossodat.html_id=84" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
