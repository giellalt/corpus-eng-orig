...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/organisation/departments/Department-Of-Children-and-Youth-Policy.html?id=81'"/>
...
<xsl:variable name="para_nob" select="'bua.html?id=81'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="barne--og-ungdomsavdelinga-.html_id=81" xml:lang="nno"/>
	<parallel_text location="bua.html_id=81" xml:lang="nob"/>
	<parallel_text location="manaid--ja-nuoraidossodat-.html_id=81" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
