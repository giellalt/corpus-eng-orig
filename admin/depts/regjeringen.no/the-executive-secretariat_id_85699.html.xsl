...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/the-ministry/organisation/Departments/the-executive-secretariat.html?id=85699'"/>
...
<xsl:variable name="para_nob" select="'ledelsens_sekretariat.html?id=85699'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sekretariat-for-leiinga.html_id=85699" xml:lang="nno"/>
	<parallel_text location="ledelsens_sekretariat.html_id=85699" xml:lang="nob"/>
	<parallel_text location="njunnoiid-allingoddi.html_id=85699" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
