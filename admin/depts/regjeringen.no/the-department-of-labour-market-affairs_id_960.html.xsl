...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-department-of-labour-market-affairs.html?id=960'"/>
...
<xsl:variable name="para_nob" select="'arba.html?id=960'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arbeidsmarknadsavdelinga.html_id=960" xml:lang="nno"/>
	<parallel_text location="arba.html_id=960" xml:lang="nob"/>
	<parallel_text location="bargomarkanossodat-.html_id=960" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
