...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Documents.html?id=313081'"/>
...
<xsl:variable name="para_nob" select="'dok.html?id=313081'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dokument.html_id=313081" xml:lang="nno"/>
	<parallel_text location="dok.html_id=313081" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
