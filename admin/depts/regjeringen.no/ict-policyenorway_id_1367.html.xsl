...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/ict-policyenorway.html?id=1367'"/>
...
<xsl:variable name="para_nob" select="'ikt-politikk.html?id=1367'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ikt-politikk.html_id=1367" xml:lang="nob"/>
	<parallel_text location="ikt-politikka.html_id=1367" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
