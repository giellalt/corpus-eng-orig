...
<xsl:variable name="filename" select="'http://regjeringen.no/en/Om-nettstedet/Help.html?id=488641'"/>
...
<xsl:variable name="para_nob" select="'Hjelp.html?id=488641'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hjelp.html_id=488641" xml:lang="nno"/>
	<parallel_text location="hjelp.html_id=488641" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
