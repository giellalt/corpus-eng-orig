...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/kampanjer/the-coordination-reform.html?id=524777'"/>
...
<xsl:variable name="para_nob" select="'samhandlingsreformen.html?id=524777'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samhandlingsreformen.html_id=524777" xml:lang="nob"/>
	<parallel_text location="ovttasdoaibmanoastus-.html_id=524777" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
