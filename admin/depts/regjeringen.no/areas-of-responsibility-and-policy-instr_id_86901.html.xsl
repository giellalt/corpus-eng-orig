...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/topics/labour-market-policy/midtspalte/areas-of-responsibility-and-policy-instr.html?id=86901'"/>
...
<xsl:variable name="para_nob" select="'ansvarsfordeling.html?id=86901'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ansvarsfordeling.html_id=86901" xml:lang="nob"/>
	<parallel_text location="ovddasvastadussuorggit-ja-vaikkuhangaskaoamit.html_id=86901" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
