...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/Organisation/Departments/The-Communication-Unit/senior-communications-officer-ingvild-da.html?id=556003'"/>
...
<xsl:variable name="para_nob" select="'ingvild-dahl-dornes.html?id=556003'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ingvild-dahl-dornes.html_id=556003" xml:lang="nob"/>
	<parallel_text location="seniorraeaddi-ingvild-dahl-dornes.html_id=556003" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
