...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/selected-topics/high-north.html?id=1154'"/>
...
<xsl:variable name="para_nob" select="'nordomradeportalen.html?id=450629'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nord_samisk.html_id=1154" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
