...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/Subordinate-agencies/the-norwegian-polar-institute.html?id=85703'"/>
...
<xsl:variable name="para_nob" select="'norsk_polarinstitutt.html?id=85703'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norsk_polarinstitutt.html_id=85703" xml:lang="nob"/>
	<parallel_text location="norgga-polarinstituhtta.html_id=85703" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
