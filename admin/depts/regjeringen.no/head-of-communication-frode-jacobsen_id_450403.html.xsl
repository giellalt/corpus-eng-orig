...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/communication-unit/head-of-communication-frode-jacobsen.html?id=450403'"/>
...
<xsl:variable name="para_nob" select="'seniorradgiver-frode-jacobsen.html?id=450403'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seniorradgiver-frode-jacobsen.html_id=450403" xml:lang="nob"/>
	<parallel_text location="gulahallanhoavda-frode-jacobsen.html_id=450403" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
