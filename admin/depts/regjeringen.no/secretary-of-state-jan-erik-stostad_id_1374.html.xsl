...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/Other-political-staff/secretary-of-state-jan-erik-stostad.html?id=1374'"/>
...
<xsl:variable name="para_nob" select="'statssekretar_jan-erik_stostad.html?id=1374'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statssekretar_jan-erik_stostad.html_id=1374" xml:lang="nob"/>
	<parallel_text location="stahtaalli-jan-erik-stostad-.html_id=1374" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
