...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-nature-management/section-for-forests-and-management-of-sp.html?id=51527'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="artsforvaltning_og_skog.html_id=51527" xml:lang="nob"/>
	<parallel_text location="luonddugahttema-ja-fuoohalddaeami-sekuvdna.html_id=51527" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
