...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed/The-Ministey/Contact.html?id=758'"/>
...
<xsl:variable name="para_nob" select="'kontakt.html?id=758'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kontakt.html_id=758" xml:lang="nno"/>
	<parallel_text location="kontakt.html_id=758" xml:lang="nob"/>
	<parallel_text location="gulahallandieut.html_id=758" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
