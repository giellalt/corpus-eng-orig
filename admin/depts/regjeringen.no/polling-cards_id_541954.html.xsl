...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/the-parliamentary-storting-election/polling-cards.html?id=541954'"/>
...
<xsl:variable name="para_nob" select="'valgkort.html?id=541954'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="valkort.html_id=541954" xml:lang="nno"/>
	<parallel_text location="valgkort.html_id=541954" xml:lang="nob"/>
	<parallel_text location="valgakoarta.html_id=541954" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
