...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/nhd/press-centre/Press-releases/2010-2/Norway-ready-to-start-negotiations-with-Russia.html?id=601877'"/>
...
<xsl:variable name="para_nob" select="'Presidentbesoket-Norge-klar-til-a-starte-handelsavtaleforhandlinger-med-Russland.html?id=601877'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="presidentbesoket-norge-klar-til-a-starte-handelsavtaleforhandlinger-med-russland.html_id=601877" xml:lang="nob"/>
	<parallel_text location="presideantagalledeapmi-norga-lea-valmma-siehtadallagoahtit-gavpesoahpamua-ruoain.html_id=601877" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
