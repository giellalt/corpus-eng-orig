...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Underliggende-etater/the-tax-administration---the-directorate.html?id=270405'"/>
...
<xsl:variable name="para_nob" select="'skatteetaten.html?id=270405'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skatteetaten.html_id=270405" xml:lang="nno"/>
	<parallel_text location="skatteetaten.html_id=270405" xml:lang="nob"/>
	<parallel_text location="vearroetahtta---vearrodirektorahtta.html_id=270405" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
