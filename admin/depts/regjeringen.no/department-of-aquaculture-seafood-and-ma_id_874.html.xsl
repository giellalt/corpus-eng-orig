...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments/department-of-aquaculture-seafood-and-ma.html?id=874'"/>
...
<xsl:variable name="para_nob" select="'avdeling_for_havbruk_sjomat_og_marked.html?id=874'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdeling-for-havbruk-sjomat-og-marknad.html_id=874" xml:lang="nno"/>
	<parallel_text location="avdeling_for_havbruk_sjomat_og_marked.html_id=874" xml:lang="nob"/>
	<parallel_text location="mearradoalu-mearrabiepmu-ja-markana-osso.html_id=874" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
