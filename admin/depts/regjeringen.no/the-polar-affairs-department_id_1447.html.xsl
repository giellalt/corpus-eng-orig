...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization/Departments/The-Polar-Affairs-Department.html?id=1447'"/>
...
<xsl:variable name="para_nob" select="'polaravdelingen.html?id=1447'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="polaravdelinga.html_id=1447" xml:lang="nno"/>
	<parallel_text location="polaravdelingen.html_id=1447" xml:lang="nob"/>
	<parallel_text location="polarossodat.html_id=1447" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
