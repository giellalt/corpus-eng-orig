...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-environmental-data-pollut/section-for-climate-change.html?id=85645'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="klima-_og_luftforurensninger.html_id=85645" xml:lang="nob"/>
	<parallel_text location="dalkkadat--ja-aibmosekuvdna.html_id=85645" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
