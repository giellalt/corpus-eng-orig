...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/nhd/about-the-ministry/organisation/Departments/administrative-department/archives-and-ict.html?id=86869'"/>
...
<xsl:variable name="para_nob" select="'arkiv.html?id=86869'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arkiv.html_id=86869" xml:lang="nob"/>
	<parallel_text location="arkiiva-ja-ikt.html_id=86869" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
