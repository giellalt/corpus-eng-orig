...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/organization/departments/the-press-and-communications-division/communications-advisor-guttorm-aanes.html?id=445775'"/>
...
<xsl:variable name="para_nob" select="'guttorm-aanes.html?id=445775'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="guttorm-aanes.html_id=445775" xml:lang="nob"/>
	<parallel_text location="seniorraeaddi-guttorm-aanes.html_id=445775" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
