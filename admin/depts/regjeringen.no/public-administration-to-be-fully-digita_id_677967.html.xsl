...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/press-centre/press-releases/2012/public-administration-to-be-fully-digita.html?id=677967'"/>
...
<xsl:variable name="para_nob" select="'regjeringen-vil-fulldigitalisere-forvalt.html_id=677967'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringen-vil-fulldigitalisere-forvalt.html_id=677967" xml:lang="nob"/>
	<parallel_text location="raehus-aigu-ollasit-digitaliseret-haldda.html_id=677967" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
