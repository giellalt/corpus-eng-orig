...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd.html?id=257'"/>
...
<xsl:variable name="para_nob" select="'fkd.html?id=257'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fkd.html_id=257" xml:lang="nno"/>
	<parallel_text location="fkd.html_id=257" xml:lang="nob"/>
	<parallel_text location="fkd.html_id=257" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
