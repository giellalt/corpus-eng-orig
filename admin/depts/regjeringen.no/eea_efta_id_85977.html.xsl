...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/department_european/eea_efta.html?id=85977'"/>
...
<xsl:variable name="para_nob" select="'eosefta.html?id=85977'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="eosefta.html_id=85977" xml:lang="nob"/>
	<parallel_text location="eesefta-sekuvdna-das-maiddai-ees-allingoddi.html_id=85977" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
