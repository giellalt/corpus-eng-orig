...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy.html?id=1403'"/>
...
<xsl:variable name="para_nob" select="'samepolitikk.html?id=1403'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samepolitikk.html_id=1403" xml:lang="nob"/>
	<parallel_text location="samepolitihkka.html_id=1403" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
