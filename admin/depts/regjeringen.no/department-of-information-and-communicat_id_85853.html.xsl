...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments/department-of-information-and-communicat.html?id=85853'"/>
...
<xsl:variable name="para_nob" select="'infomasjonsenheten.html?id=85853'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kommunikasjonseinga.html_id=85853" xml:lang="nno"/>
	<parallel_text location="infomasjonsenheten.html_id=85853" xml:lang="nob"/>
	<parallel_text location="gulahallanovttadat.html_id=85853" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
