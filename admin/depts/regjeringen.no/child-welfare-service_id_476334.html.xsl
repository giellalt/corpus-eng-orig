...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/Child-welfare/Child-welfare-service.html?id=476334'"/>
...
<xsl:variable name="para_nob" select="'barnevernets-oppgaver.html?id=476334'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="barnevernets-oppgaver.html_id=476334" xml:lang="nob"/>
	<parallel_text location="manaidsuodjalusa-doaimmat.html_id=476334" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
