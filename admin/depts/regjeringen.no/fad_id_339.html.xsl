...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad.html?id=339'"/>
...
<xsl:variable name="para_nob" select="'fad.html?id=339'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fad.html_id=339" xml:lang="nno"/>
	<parallel_text location="fad.html_id=339" xml:lang="nob"/>
	<parallel_text location="fad.html_id=339" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
