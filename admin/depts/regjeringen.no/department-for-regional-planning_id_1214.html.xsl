...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-regional-planning.html?id=1214'"/>
...
<xsl:variable name="para_nob" select="'regional_planlegging.html?id=1214'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regional_planlegging.html_id=1214" xml:lang="nob"/>
	<parallel_text location="regiunala-planema-lavdegoddi-.html_id=1214" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
