...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/organisation/departments/department-of-public-roads-and-rail-tran/director-general-knut-ronning.html?id=332362'"/>
...
<xsl:variable name="para_nob" select="'ekspedisjonssjef-knut-ronning.html?id=332362'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekspedisjonssjef-knut-ronning.html_id=332362" xml:lang="nno"/>
	<parallel_text location="ekspedisjonssjef-knut-ronning.html_id=332362" xml:lang="nob"/>
	<parallel_text location="ekspediuvdnahoavda-knut-ronning.html_id=332362" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
