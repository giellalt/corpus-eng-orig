...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-regional-planning/spatial-information-analysis.html?id=85668'"/>
...
<xsl:variable name="para_nob" select="'kart-analyse-planinformasjon.html?id=85668'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kart-analyse-planinformasjon.html_id=85668" xml:lang="nob"/>
