...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-regional-planning/urban-development.html?id=85665'"/>
...
<xsl:variable name="para_nob" select="'byutvikling.html?id=85665'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="byutvikling.html_id=85665" xml:lang="nob"/>
	<parallel_text location="gavpotovddidan-regiunala-areala--ja-geasehanpolitihkka-sekuvdna.html_id=85665" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
