...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/the-parliamentary-storting-election/right-to-vote-and-electoral-register.html?id=457100'"/>
    ...
    <xsl:variable name="author1_ln" select="'Ministry of Local Government and Regional Development'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="du-ma-ha-stemmerett-og-sta-i-manntallet_id_457100.html"/>
