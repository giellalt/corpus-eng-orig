...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/Site-Map.html?id=313857'"/>
...
<xsl:variable name="para_nob" select="'nettstedskart.html?id=313857'"/>
