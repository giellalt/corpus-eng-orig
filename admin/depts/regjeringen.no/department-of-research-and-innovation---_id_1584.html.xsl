...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/organisation/Departments/Department-of-research-and-innovation---.html?id=1584'"/>
...
<xsl:variable name="para_nob" select="'forsknings-_og_innovasjonsavdelingen.html?id=1584'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskings-og-innovasjonsavdelinga.html_id=1584" xml:lang="nno"/>
	<parallel_text location="forsknings-_og_innovasjonsavdelingen.html_id=1584" xml:lang="nob"/>
	<parallel_text location="forsknings--og-innovasjonsavdelingen.html_id=1584" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
