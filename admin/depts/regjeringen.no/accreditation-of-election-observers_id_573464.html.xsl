...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/election-observation/accreditation-of-election-observers.html?id=573464'"/>
...
<xsl:variable name="para_nob" select="'akkreditering-av-valgobservatorer.html?id=573464'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="akkreditering-av-valgobservatorer.html_id=573464" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
