...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po.html?id=468'"/>
...
<xsl:variable name="para_nob" select="'dep.html?id=468'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="om-departementet.html_id=468" xml:lang="nno"/>
	<parallel_text location="dep.html_id=468" xml:lang="nob"/>
	<parallel_text location="justisdepartementta-birra.html_id=468" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
