...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Underliggende-etater/the-financial-supervisory-authority.html?id=270404'"/>
...
<xsl:variable name="para_nob" select="'kredittilsynet.html?id=270404'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kredittilsynet.html_id=270404" xml:lang="nno"/>
	<parallel_text location="kredittilsynet.html_id=270404" xml:lang="nob"/>
	<parallel_text location="kredihttabearraigeahu.html_id=270404" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
