...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new/Speeches-and-articles/statsministeren/statsminister_jens_stoltenberg/2012/speech-in-connection-with-the-government.html?id=672443'"/>
...
<xsl:variable name="para_nob" select="'gaver-til-kong-harald-og-dronning-sonja.html_id=672443'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gaver-til-kong-harald-og-dronning-sonja.html_id=672443" xml:lang="nob"/>
	<parallel_text location="gonagasskeakkat-75-jagi.html_id=672443" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
