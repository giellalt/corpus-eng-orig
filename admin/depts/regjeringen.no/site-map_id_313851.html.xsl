...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/Site-Map.html?id=313851'"/>
...
<xsl:variable name="para_nob" select="'nettstedskart.html?id=313851'"/>
