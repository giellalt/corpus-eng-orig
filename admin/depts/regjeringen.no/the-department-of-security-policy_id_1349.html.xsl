...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/the-ministry/organisation/Departments/The-Department-of-Security-Policy.html?id=1349'"/>
...
<xsl:variable name="para_nob" select="'avdeling_for_sikkerhetspolitikk.html?id=1349'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdeling-for-tryggleikspolitikk.html_id=1349" xml:lang="nno"/>
	<parallel_text location="avdeling_for_sikkerhetspolitikk.html_id=1349" xml:lang="nob"/>
	<parallel_text location="sihkkarvuoapolitihka-ossodat.html_id=1349" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
