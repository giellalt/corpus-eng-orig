...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kud/press-centre/press-releases/2012/agreement-on-nordic-award-for-children-a.html?id=680045'"/>
...
<xsl:variable name="para_nob" select="'enighet-om-nordisk-pris-for-barne--og-un.html_id=680045'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="enighet-om-nordisk-pris-for-barne--og-un.html_id=680045" xml:lang="nob"/>
	<parallel_text location="ovttamielalavuohta-asahit-davviriikkala-.html_id=680045" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
