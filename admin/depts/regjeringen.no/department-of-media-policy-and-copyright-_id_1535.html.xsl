...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/Organisation/Departments/Department-of-Media-Policy-and-Copyright-.html?id=1535'"/>
...
<xsl:variable name="para_nob" select="'medieavdelingen_.html?id=1535'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="medieavdelinga.html_id=1535" xml:lang="nno"/>
	<parallel_text location="medieavdelingen_.html_id=1535" xml:lang="nob"/>
	<parallel_text location="mediaossodat.html_id=1535" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
