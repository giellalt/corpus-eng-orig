...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kld/press-centre/Press-releases/2013/the-ministry-of-the-environment-becomes-.html?id=748447'"/>
...
<xsl:variable name="para_nob" select="'miljoverndepartementet-blir-til-klima--o.html_id=748447'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="miljoverndepartementet-blir-til-klima--o.html_id=748447" xml:lang="nob"/>
	<parallel_text location="birasdepartemeanta-adda-dalkkadat--ja-bi.html_id=748447" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
