...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/security_policy/security_policy.html?id=1514'"/>
...
<xsl:variable name="para_nob" select="'seksjon_for_sikkerhetspolitikk_og_bilate.html?id=1514'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon_for_sikkerhetspolitikk_og_bilate.html_id=1514" xml:lang="nob"/>
	<parallel_text location="sihkkarvuoa-ja-davvi-amerihka-sekuvdna.html_id=1514" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
