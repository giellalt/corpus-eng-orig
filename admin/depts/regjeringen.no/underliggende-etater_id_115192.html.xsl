...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/Underliggende-etater.html?id=115192'"/>
...
<xsl:variable name="para_nob" select="'underliggende_etater.html?id=115192'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="etatar-og-verksemder.html_id=115192" xml:lang="nno"/>
	<parallel_text location="underliggende_etater.html_id=115192" xml:lang="nob"/>
	<parallel_text location="vuollasa-asahusat.html_id=115192" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
