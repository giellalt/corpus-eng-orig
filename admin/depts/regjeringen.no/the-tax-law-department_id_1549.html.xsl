...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/The-Tax-Law-Department.html?id=1549'"/>
...
<xsl:variable name="para_nob" select="'skattelovavdelingen.html?id=1549'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skattelovavdelinga.html_id=1549" xml:lang="nno"/>
	<parallel_text location="skattelovavdelingen.html_id=1549" xml:lang="nob"/>
	<parallel_text location="vearrolahkaossodat.html_id=1549" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
