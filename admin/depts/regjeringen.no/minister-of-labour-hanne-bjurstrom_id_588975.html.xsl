...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/about-the-ministry/minister-of-labour-hanne-bjurstrom.html?id=588975'"/>
...
<xsl:variable name="para_nob" select="'arbeidsminister-hanne-bjurstrom.html?id=588975'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arbeidsminister-hanne-bjurstrom.html_id=588975" xml:lang="nno"/>
