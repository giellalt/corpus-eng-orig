...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld.html?id=298'"/>
...
<xsl:variable name="para_nob" select="'bld.html?id=298'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bld.html_id=298" xml:lang="nno"/>
	<parallel_text location="bld.html_id=298" xml:lang="nob"/>
	<parallel_text location="bld.html_id=298" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
