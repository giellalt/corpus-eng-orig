...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/organisation/departments/communications-department.html?id=555839'"/>
...
<xsl:variable name="para_nob" select="'kommunikasjonsavdelingen.html?id=555839'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kommunikasjonsavdelinga.html_id=555839" xml:lang="nno"/>
	<parallel_text location="kommunikasjonsavdelingen.html_id=555839" xml:lang="nob"/>
	<parallel_text location="dieihanovttadat.html_id=555839" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
