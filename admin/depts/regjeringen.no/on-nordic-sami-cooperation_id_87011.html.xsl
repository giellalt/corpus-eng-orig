...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/Sami-policy/nordic-sami-cooperation/on-nordic-sami-cooperation.html?id=87011'"/>
...
<xsl:variable name="para_nob" select="'om-nordisk-samisk-samarbeid.html?id=87011'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="om-nordisk-samisk-samarbeid.html_id=87011" xml:lang="nob"/>
	<parallel_text location="davviriikkala-sami-ovttasbargu.html_id=87011" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
