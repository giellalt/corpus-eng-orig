...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/other-political-staff/political-adviser-roger-remme-solheim.html?id=583029'"/>
...
<xsl:variable name="para_nob" select="'politisk-radgiver-roger-remme-solheim.html?id=583029'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="politisk-radgivar-roger-remme-solheim.html_id=583029" xml:lang="nno"/>
	<parallel_text location="politisk-radgiver-roger-remme-solheim.html_id=583029" xml:lang="nob"/>
	<parallel_text location="politihkala-raeaddi-roger-remme-solheim.html_id=583029" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
