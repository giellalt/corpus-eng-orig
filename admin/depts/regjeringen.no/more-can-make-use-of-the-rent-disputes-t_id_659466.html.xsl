...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2011/more-can-make-use-of-the-rent-disputes-t.html?id=659466'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Eanet olbmot sáhttet dál geavahit Viessoláigoriidolávdegotti - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'fleire.html_id=659466'"/>
<xsl:variable name="para_nob" select="'regjeringen-prioriterer-utviklingen-av-d.html_id=659582'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eanet-olbmot-sahttet-dal-geavahit-viesso.html_id=659466'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fleire.html_id=659466" xml:lang="nno"/>
	<parallel_text location="regjeringen-prioriterer-utviklingen-av-d.html_id=659582" xml:lang="nob"/>
	<parallel_text location="eanet-olbmot-sahttet-dal-geavahit-viesso.html_id=659466" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
