...
<xsl:variable name="para_nno" select="'auka-skatteinntekter-til-kommunane-i-201.html_id=660065'"/>
<xsl:variable name="para_nob" select="'regjeringen-prioriterer-utviklingen-av-d.html_id=659582'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eanet-vearroboaut-gielddaide-2011.html_id=660065'"/>
