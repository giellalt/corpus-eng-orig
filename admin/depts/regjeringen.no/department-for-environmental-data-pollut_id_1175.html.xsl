...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-environmental-data-pollut.html?id=1175'"/>
...
<xsl:variable name="para_nob" select="'forurensningssaker.html?id=1175'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forurensningssaker.html_id=1175" xml:lang="nob"/>
	<parallel_text location="nuoskkidanaiid-ossodat.html_id=1175" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
