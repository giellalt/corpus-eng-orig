...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/press/news/2010/Russia-and-Norway-sign-agreement-on-local-border-traffic-regime.html?id=622461'"/>
...
<xsl:variable name="para_nob" select="'noreg-og-russland-underteiknar-avtale-om.html?id=622461'"/>
