...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs.html?id=262'"/>
...
<xsl:variable name="para_nob" select="'dep.html?id=262'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="om-departementet.html_id=262" xml:lang="nno"/>
	<parallel_text location="dep.html_id=262" xml:lang="nob"/>
	<parallel_text location="departemeanta-birra.html_id=262" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
