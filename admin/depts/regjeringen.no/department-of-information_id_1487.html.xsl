...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/Organisation/Departments/department-of-information.html?id=1487'"/>
...
<xsl:variable name="para_nob" select="'informasjonsenheten_.html?id=1487'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="informasjonseininga.html_id=1487" xml:lang="nno"/>
	<parallel_text location="informasjonsenheten_.html_id=1487" xml:lang="nob"/>
	<parallel_text location="diehtojuohkinovttadat-.html_id=1487" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
