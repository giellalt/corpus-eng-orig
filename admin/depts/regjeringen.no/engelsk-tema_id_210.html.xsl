...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/engelsk-tema.html?id=210'"/>
...
<xsl:variable name="para_nob" select="'arbeid_og_velferd.html?id=210'"/>
