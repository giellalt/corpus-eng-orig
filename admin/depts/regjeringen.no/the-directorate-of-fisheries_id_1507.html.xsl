...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/The-Ministry-of-Fisheries-and-Coastal-Affairs/Subordinate-agencies-and-institutions/The-Directorate-of-Fisheries.html?id=1507'"/>
...
<xsl:variable name="para_nob" select="'fiskeridirektoratet.html?id=1507'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fiskeridirektoratet.html_id=1507" xml:lang="nno"/>
	<parallel_text location="fiskeridirektoratet.html_id=1507" xml:lang="nob"/>
	<parallel_text location="guolastusdirektorahta.html_id=1507" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
