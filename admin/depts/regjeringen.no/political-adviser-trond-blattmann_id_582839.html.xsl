...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Other-political-staff/political-adviser-trond-blattmann.html?id=582839'"/>
...
<xsl:variable name="para_nob" select="'politisk-radgiver-trond-blattmann.html?id=582839'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="politisk-radgiver-trond-blattmann.html_id=582839" xml:lang="nob"/>
	<parallel_text location="politihkala-raeaddi-trond-blattmann.html_id=582839" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
