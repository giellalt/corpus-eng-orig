...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/security_policy/polar_affairs.html?id=85981'"/>
...
<xsl:variable name="para_nob" select="'nord_ressurser.html?id=85981'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nord_ressurser.html_id=85981" xml:lang="nob"/>
	<parallel_text location="davviguovlluid-resurssaid-ja-ruoa-ossodat.html_id=85981" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
