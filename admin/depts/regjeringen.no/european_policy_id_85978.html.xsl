...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/department_european/european_policy.html?id=85978'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="europapolitisk_seksjon.html_id=85978" xml:lang="nob"/>
	<parallel_text location="eurohpapolitihka-sekuvdna-.html_id=85978" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
