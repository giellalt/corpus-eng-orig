...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/About-the-Ministry/Contact-information.html?id=429'"/>
...
<xsl:variable name="para_nob" select="'kontakt.html?id=429'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kontakt.html_id=429" xml:lang="nno"/>
	<parallel_text location="kontakt.html_id=429" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
