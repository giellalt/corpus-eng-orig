...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2012/population-growing-in-311-municipalities.html?id=673303'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Olmmošlohku lassána 311 gielddas - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'olmmolohku-lassana-311-gielddas.html_id=673303'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="vekst-i-folketalet-i-311-kommunar-_id_673303.html" xml:lang="nno"/>
	<parallel_text location="mangel-pa-samisk-larere-og-laremidler_id_673673.html" xml:lang="nob"/>
	<parallel_text location="olmmolohku-lassana-311-gielddas_id_673303.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
