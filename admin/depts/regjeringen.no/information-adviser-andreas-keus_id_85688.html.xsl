...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/press-and-information-unit/information-adviser-andreas-keus.html?id=85688'"/>
...
<xsl:variable name="para_nob" select="'andreas_keus.html?id=85688'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="andreas_keus.html_id=85688" xml:lang="nob"/>
	<parallel_text location="diehtojuohkinraeaddi-anders-keus.html_id=85688" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
