...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/contact-information.html?id=676'"/>
...
<xsl:variable name="para_nob" select="'kontakt.html?id=676'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kontakt.html_id=676" xml:lang="nob"/>
	<parallel_text location="oktavuohtadiehtojuohkin.html_id=676" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
