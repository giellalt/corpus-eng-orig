...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-nature-management/section-for-outdoor-recreation-and-land-.html?id=45920'"/>
...
<xsl:variable name="para_nob" select="'friluftsliv_og_arealforvaltning.html?id=45920'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="friluftsliv_og_arealforvaltning.html_id=45920" xml:lang="nob"/>
	<parallel_text location="olgoaibmodoaimmaid-ja-arealahalddaeami-sekuvdna.html_id=45920" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
