...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Business-and-industry.html?id=926'"/>
...
<xsl:variable name="para_nob" select="'naringsliv.html?id=926'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="naringsliv.html_id=926" xml:lang="nno"/>
	<parallel_text location="naringsliv.html_id=926" xml:lang="nob"/>
	<parallel_text location="ealahuseallin.html_id=926" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
