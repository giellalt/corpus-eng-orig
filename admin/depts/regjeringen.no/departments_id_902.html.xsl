...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/The-Office-of-the-Prime-Minister/Organisation/Departments.html?id=902'"/>
...
<xsl:variable name="para_nob" select="'avdelinger.html?id=902'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdelingar.html_id=902" xml:lang="nno"/>
	<parallel_text location="avdelinger.html_id=902" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
