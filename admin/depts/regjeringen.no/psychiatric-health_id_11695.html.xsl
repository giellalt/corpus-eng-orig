...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/Subjects/psychiatric-health.html?id=11695'"/>
...
<xsl:variable name="para_nob" select="'psykisk_helse.html?id=11695'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="psykisk_helse.html_id=11695" xml:lang="nob"/>
	<parallel_text location="psykala-dearvvavuohta.html_id=11695" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
