...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2010/Norway-welcomes-agreement-in-Cancun.html?id=628050'"/>
...
<xsl:variable name="para_nob" select="'enighet.html?id=628050'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="enighet.html_id=628050" xml:lang="nob"/>
	<parallel_text location="cancunas.html_id=628050" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
