...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/Press-Centre/Press-releases/2012/discussed-fish-discards-with-the-europea.html?id=679380'"/>
...
<xsl:variable name="para_nob" select="'diskuterte-utkast-av-fisk-med-europaparl.html_id=679380'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="diskuterte-utkast-av-fisk-med-europaparl.html_id=679380" xml:lang="nob"/>
	<parallel_text location="digatalle-guolastusarvalusa-eurohpa-parl.html_id=679380" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
