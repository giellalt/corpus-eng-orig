...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/Other-political-staff/secretary-of-state-dag-henrik-sandbakken.html?id=1505'"/>
...
<xsl:variable name="para_nob" select="'statssekretar_sandbakken.html?id=1505'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statssekretar_sandbakken.html_id=1505" xml:lang="nob"/>
	<parallel_text location="stahtaalli-dag-henrik-sandbakken.html_id=1505" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
