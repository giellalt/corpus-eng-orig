...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/organisation/departments/information-secretariat.html?id=87086'"/>
...
<xsl:variable name="para_nob" select="'kommunikasjonsenheten.html?id=87086'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="informasjonssekretariatet.html_id=87086" xml:lang="nno"/>
	<parallel_text location="kommunikasjonsenheten.html_id=87086" xml:lang="nob"/>
	<parallel_text location="diehtojuohkinallingoddi-.html_id=87086" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
