...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/about-the-ministry/Organisation/Departments/department-of-competition-policy.html?id=1588'"/>
...
<xsl:variable name="para_nob" select="'konkurransepolitisk_avdeling.html?id=1588'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="konkurransepolitisk_avdeling.html_id=1588" xml:lang="nob"/>
	<parallel_text location="gilvopolitihkala-ossodat.html_id=1588" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
