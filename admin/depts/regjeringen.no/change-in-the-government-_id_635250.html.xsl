...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2011/change-in-the-government-.html?id=635250'"/>
...
<xsl:variable name="para_nob" select="'endring-i-regjeringen.html_id=635250'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="endring-i-regjeringen.html_id=635250" xml:lang="nob"/>
	<parallel_text location="nuppastusat-raehusas.html_id=635250" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
