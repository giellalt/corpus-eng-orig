...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/jd/About-the-Ministry-of-Justice-and-the-Po/Organization/Departments/Rescue-and-Emergency-Planning-Department.html?id=1470'"/>
...
<xsl:variable name="para_nob" select="'rednings-_og_beredskapsshyavdelingen_.html?id=1470'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rednings--og-beredskapsavdelinga.html_id=1470" xml:lang="nno"/>
	<parallel_text location="rednings-_og_beredskapsshyavdelingen_.html_id=1470" xml:lang="nob"/>
	<parallel_text location="gadjun--ja-valmmastanossodat-.html_id=1470" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
