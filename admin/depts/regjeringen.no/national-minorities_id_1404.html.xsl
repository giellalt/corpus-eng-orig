...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/Selected-topics/national-minorities.html?id=1404'"/>
...
<xsl:variable name="para_nob" select="'nasjonale_minoriteter.html?id=1404'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nasjonale-minoritetar.html_id=1404" xml:lang="nno"/>
	<parallel_text location="nasjonale_minoriteter.html_id=1404" xml:lang="nob"/>
	<parallel_text location="nationala-unnitlogut.html_id=1404" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
