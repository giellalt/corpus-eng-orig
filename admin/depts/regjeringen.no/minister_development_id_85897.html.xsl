...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/minister_development.html?id=85897'"/>
...
<xsl:variable name="para_nob" select="'utviklingsminister_erik_solheim_sv.html?id=85897'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utviklingsminister-erik-solheim-sv.html_id=85897" xml:lang="nno"/>
	<parallel_text location="utviklingsminister_erik_solheim_sv.html_id=85897" xml:lang="nob"/>
	<parallel_text location="stahtarai-erik-solheim-sg.html_id=85897" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
