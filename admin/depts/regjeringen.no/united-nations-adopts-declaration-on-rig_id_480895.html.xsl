...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/aid/press-centre/press-releases/2007/United-Nations-adopts-Declaration-on-Rig.html?id=480895'"/>
...
<xsl:variable name="para_nob" select="'111.html?id=480895'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="111.html_id=480895" xml:lang="nob"/>
	<parallel_text location="eamialbmotjulggatus-maid-ona-valdooahkki.html_id=480895" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
