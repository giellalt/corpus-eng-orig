...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2011/the-government-continues-its-initiatives.html?id=659463'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ráđđehus joatká veahkehit sin geat rahčet eanemusat ássanviesumárkanis - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'regjeringa-vidareforer-innsatsen-for-d-2.html_id=659463'"/>
<xsl:variable name="para_nob" select="'regjeringen-prioriterer-utviklingen-av-d.html_id=659582'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'raehus-joatka-veahkehit-sin-geat-rahet-e.html_id=659463'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringa-vidareforer-innsatsen-for-d-2_id_659463.html" xml:lang="nno"/>
	<parallel_text location="" xml:lang="nob"/>
	<parallel_text location="raehus-joatka-veahkehit-sin-geat-rahet-e_id_659463.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
