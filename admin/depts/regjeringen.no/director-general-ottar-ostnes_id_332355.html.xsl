...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/sd/about-the-ministry/organisation/departments/department-of-civil-aviation-postal-serv/director-general-ottar-ostnes.html?id=332355'"/>
...
<xsl:variable name="para_nob" select="'ekspedisjonssjef-.html?id=332355'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekspedisjonssjef-ottar-ostnes.html_id=332355" xml:lang="nno"/>
	<parallel_text location="ekspedisjonssjef-.html_id=332355" xml:lang="nob"/>
	<parallel_text location="ekspediuvdnahoavda-.html_id=332355" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
