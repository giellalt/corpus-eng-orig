...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/the-parliamentary-storting-election/where-can-you-cast-your-vote.html?id=541963'"/>
...
<xsl:variable name="para_nob" select="'hvor-kan-du-stemme.html?id=541963'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kvar-kan-du-royste.html_id=541963" xml:lang="nno"/>
	<parallel_text location="hvor-kan-du-stemme.html_id=541963" xml:lang="nob"/>
	<parallel_text location="gos-beasat-jienastit.html_id=541963" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
