...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/Subjects/rural-and-regional-policy/development-of-companies-and-business-en/established-companies.html?id=530953'"/>
<xsl:variable name="title" select="'Ásahuvvon fitnodagat - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'etablerte-bedrifter.html?id=530953'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Asahuvvon-fitnodagat.html?id=530953'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="etablerte-bedrifter_id_530953.html" xml:lang="nno"/>
	<parallel_text location="asahuvvon-fitnodagat_id_530953.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
