...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/nhd/about-the-ministry/organisation/Departments/administrative-department/budgeting-and-finance.html?id=86862'"/>
...
<xsl:variable name="para_nob" select="'budsjett-og-okonomi.html?id=86862'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="budsjett-og-okonomi.html_id=86862" xml:lang="nob"/>
	<parallel_text location="bueahtta-ja-ekonomiija.html_id=86862" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
