...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/min/Organisation/Departments/The-Communication-Unit/head-of-information-anne-marit-schiong.html?id=446500'"/>
...
<xsl:variable name="para_nob" select="'ams.html?id=446500'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ams.html_id=446500" xml:lang="nob"/>
	<parallel_text location="nubbinjoiheaddji-anne-marit-schiong.html_id=446500" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
