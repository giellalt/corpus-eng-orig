...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/upper-secondary-education.html?id=87102'"/>
...
<xsl:variable name="para_nob" select="'videregaende-opplaring.html?id=87102'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="videregaende-opplaring.html_id=87102" xml:lang="nob"/>
	<parallel_text location="joatkkaoahpahus.html_id=87102" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
