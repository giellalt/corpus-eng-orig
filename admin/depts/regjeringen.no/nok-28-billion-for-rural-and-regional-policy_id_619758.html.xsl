...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2010/NOK-28-billion-for-rural-and-regional-policy.html?id=619758'"/>
    ...
    <xsl:variable name="wordcount" select="'558'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="28-milliardar-kroner-til-distrikts--og-regionalpolitikken_id_619758.html"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="28-miljardda-ruvdno-bire--ja-guovlopolit_id_619758.html"/>
