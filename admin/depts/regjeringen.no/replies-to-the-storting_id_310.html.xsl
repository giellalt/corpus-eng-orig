...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Whats-new/Replies-to-the-Storting.html?id=310'"/>
...
<xsl:variable name="para_nob" select="'svar_stortinget.html?id=310'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="svar-til-stortinget.html_id=310" xml:lang="nno"/>
	<parallel_text location="svar_stortinget.html_id=310" xml:lang="nob"/>
	<parallel_text location="vastadusat-stuorradiggai.html_id=310" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
