...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/press-center/press-releases/2012/imf-expresses-appreciation-to-norway-for.html?id=678775'"/>
...
<xsl:variable name="para_nob" select="'imf-takker-norge-for-lanetilbud.html_id=678775'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="imf-takker-norge-for-lanetilbud.html_id=678775" xml:lang="nob"/>
	<parallel_text location="imf-giita-norgga-loatnafalaldaga-ovddas.html_id=678775" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
