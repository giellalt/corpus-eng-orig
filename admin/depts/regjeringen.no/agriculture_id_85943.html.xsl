...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Food-fisheries-and-agriculture/agriculture.html?id=85943'"/>
...
<xsl:variable name="para_nob" select="'landbruk.html?id=85943'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="landbruk.html_id=85943" xml:lang="nno"/>
	<parallel_text location="landbruk.html_id=85943" xml:lang="nob"/>
	<parallel_text location="eanadoallu.html_id=85943" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
