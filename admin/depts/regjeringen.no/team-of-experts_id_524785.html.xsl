...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/hod/kampanjer/the-coordination-reform/team-of-experts.html?id=524785'"/>
...
<xsl:variable name="para_nob" select="'ekspertgruppa.html?id=524785'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekspertgruppa.html_id=524785" xml:lang="nob"/>
	<parallel_text location="medlemmene-i-ekspertgruppa.html_id=524785" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
