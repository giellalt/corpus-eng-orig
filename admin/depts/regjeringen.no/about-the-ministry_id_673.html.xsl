...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry.html?id=673'"/>
...
<xsl:variable name="para_nob" select="'dep.html?id=673'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="om-departementet.html_id=673" xml:lang="nno"/>
	<parallel_text location="dep.html_id=673" xml:lang="nob"/>
	<parallel_text location="departemeanta-birra.html_id=673" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
