...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/minister-of-finance-sigbjorn-johnsen.html?id=582364'"/>
...
<xsl:variable name="para_nob" select="'finansminister-sigbjorn-johnsen.html?id=582364'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="finansminister-sigbjorn-johnsen.html_id=582364" xml:lang="nno"/>
	<parallel_text location="finansminister-sigbjorn-johnsen.html_id=582364" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
