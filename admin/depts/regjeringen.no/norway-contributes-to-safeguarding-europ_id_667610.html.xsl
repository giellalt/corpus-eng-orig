...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2011/norway-contributes-to-safeguarding-europ.html?id=667610'"/>
...
<xsl:variable name="para_nob" select="'bidrar-til-stabilisering-av-internasjona.html_id=667610'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bidrar-til-stabilisering-av-internasjona.html_id=667610" xml:lang="nob"/>
	<parallel_text location="aigu-sihkkarastit-eurohpala-ekonomiija-.html_id=667610" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
