...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/About-the-Ministry/areas-of-responsibilities.html?id=611'"/>
...
<xsl:variable name="para_nob" select="'ansvarsomraader.html?id=611'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ansvarsomrade.html_id=611" xml:lang="nno"/>
	<parallel_text location="ansvarsomraader.html_id=611" xml:lang="nob"/>
	<parallel_text location="ovddasvastadussuorggit.html_id=611" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
