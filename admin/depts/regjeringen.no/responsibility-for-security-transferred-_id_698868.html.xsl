...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/whats-new/News/2012/responsibility-for-security-transferred-.html?id=698868'"/>
...
<xsl:variable name="para_nob" select="'overforer-sikkerhetsansvaret-til-afghans.html_id=698868'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="overforer-sikkerhetsansvaret-til-afghans.html_id=698868" xml:lang="nob"/>
	<parallel_text location="sirda-sihkarvuoaovddasvastadusa-afganist.html_id=698868" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
