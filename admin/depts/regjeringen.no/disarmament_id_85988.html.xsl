...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/security_policy/disarmament.html?id=85988'"/>
...
<xsl:variable name="para_nob" select="'seksjon_for_nedrustning_og_ikke-sprednin.html?id=85988'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon_for_nedrustning_og_ikke-sprednin.html_id=85988" xml:lang="nob"/>
	<parallel_text location="vearjjuid-geahpedeami-ja-vearjjuid-viidananeastadeami-sekuvdna.html_id=85988" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
