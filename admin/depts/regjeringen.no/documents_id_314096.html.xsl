...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/Documents.html?id=314096'"/>
...
<xsl:variable name="para_nob" select="'dok.html?id=314096'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dokument.html_id=314096" xml:lang="nno"/>
	<parallel_text location="dok.html_id=314096" xml:lang="nob"/>
	<parallel_text location="dokumeanttat.html_id=314096" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
