...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/election-observation/about-election-observation.html?id=573463'"/>
...
<xsl:variable name="para_nob" select="'om-valgobservasjon.html?id=573463'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="om-valgobservasjon.html_id=573463" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
