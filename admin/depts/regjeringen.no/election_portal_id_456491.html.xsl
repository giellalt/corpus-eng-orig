...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal.html?id=456491'"/>
...
<xsl:variable name="para_nob" select="'valg.html?id=456491'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="valportalen.html_id=456491" xml:lang="nno"/>
	<parallel_text location="valg.html_id=456491" xml:lang="nob"/>
	<parallel_text location="valga-portal.html_id=456491" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
