...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fad/press-centre/press-releases/2011/stricter-enforcement-of-public-procureme.html?id=662949'"/>
...
<xsl:variable name="para_nno" select="'skjerpa-handheving-av-offentlege-innkjop.html_id=662949'"/>
<xsl:variable name="para_nob" select="'skjerpet-handhevelse-av-offentlige-anska.html_id=662949'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skjerpa-handheving-av-offentlege-innkjop.html_id=662949" xml:lang="nno"/>
	<parallel_text location="skjerpet-handhevelse-av-offentlige-anska.html_id=662949" xml:lang="nob"/>
	<parallel_text location="almmola-hahkamiid-njuolggadusat-avget.html_id=662949" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
