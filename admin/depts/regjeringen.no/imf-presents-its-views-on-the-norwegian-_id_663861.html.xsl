...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/press-center/press-releases/2011/imf-presents-its-views-on-the-norwegian-.html?id=663861'"/>
...
<xsl:variable name="para_nob" select="'imf-med-ny-vurdering-av-norsk-okonomi.html_id=663861'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="imf-med-ny-vurdering-av-norsk-okonomi.html_id=663861" xml:lang="nob"/>
	<parallel_text location="imf-oa-norgga-ekonomiija-arvvotallan.html_id=663861" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
