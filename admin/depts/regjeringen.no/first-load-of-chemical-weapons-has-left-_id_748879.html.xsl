...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/press-centre/Press-releases/20141/first-load-of-chemical-weapons-has-left-.html?id=748879'"/>
...
<xsl:variable name="para_nob" select="'forste-last-av-kjemiske-vapen-fra-syria.html_id=748879'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forste-last-av-kjemiske-vapen-fra-syria.html_id=748879" xml:lang="nob"/>
	<parallel_text location="syrias-fievrredit-vuostta-guorpmi-kemihk.html_id=748879" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
