...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/The-Office-of-the-Prime-Minister/Historical-background.html?id=85907'"/>
...
<xsl:variable name="para_nob" select="'historie.html?id=85907'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="historie.html_id=85907" xml:lang="nob"/>
	<parallel_text location="historja.html_id=85907" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
