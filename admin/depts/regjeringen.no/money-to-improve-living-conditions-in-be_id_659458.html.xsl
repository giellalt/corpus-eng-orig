...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2011/money-to-improve-living-conditions-in-be.html?id=659458'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Eallindili buorideapmái ruhta Bergenis ja Troandimis   - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'pengar-til-betre-levekar-i-bergen-og-t-2.html_id=659458'"/>
<xsl:variable name="para_nob" select="'regjeringen-prioriterer-utviklingen-av-d.html_id=659582'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eallindili-buorideapmai-ruhta-bergenis-j.html_id=659458'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pengar-til-betre-levekar-i-bergen-og-t-2_id_659458.html" xml:lang="nno"/>
	<parallel_text location="" xml:lang="nob"/>
	<parallel_text location="eallindili-buorideapmai-ruhta-bergenis-j_id_659458.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
