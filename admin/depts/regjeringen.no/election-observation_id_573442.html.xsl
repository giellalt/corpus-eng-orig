...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/election-observation.html?id=573442'"/>
...
<xsl:variable name="para_nob" select="'valgobservasjon.html?id=573442'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="valgobservasjon_id_573442.html" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
