...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/documents.html?id=272507'"/>
...
<xsl:variable name="para_nob" select="'dok.html?id=272507'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dokument.html_id=272507" xml:lang="nno"/>
	<parallel_text location="dok.html_id=272507" xml:lang="nob"/>
	<parallel_text location="dokumeanttat.html_id=272507" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
