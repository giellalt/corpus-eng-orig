...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2012/municipal-tax-revenues-saw-strong-growth.html?id=701326'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Gielddaid vearrodietnasat lassánit garrasit jagi 2012 - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'auka-skatteinntekter-til-kommunane-i-201.html_id=701326'"/>
...
<xsl:variable name="para_sme" select="'gielddaid-vearrodietnasat-lassanit-garra.html_id=701326'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gielddaid-vearrodietnasat-lassanit-garra_id_701326.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
