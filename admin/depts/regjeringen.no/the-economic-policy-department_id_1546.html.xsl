...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fin/The-Ministry/About-the-Ministry/Departments/The-Economic-Policy-Department.html?id=1546'"/>
...
<xsl:variable name="para_nob" select="'okonomiavdelingen.html?id=1546'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okonomiavdelinga.html_id=1546" xml:lang="nno"/>
	<parallel_text location="okonomiavdelingen.html_id=1546" xml:lang="nob"/>
	<parallel_text location="ekonomiijaossodat-.html_id=1546" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
