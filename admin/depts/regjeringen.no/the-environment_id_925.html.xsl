...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/The-environment.html?id=925'"/>
...
<xsl:variable name="para_nob" select="'miljo.html?id=925'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="miljo.html_id=925" xml:lang="nno"/>
	<parallel_text location="miljo.html_id=925" xml:lang="nob"/>
	<parallel_text location="biras.html_id=925" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
