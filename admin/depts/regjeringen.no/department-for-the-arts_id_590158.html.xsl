...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kkd/about-the-ministry/Organisation/Departments/Department-for-the-Arts.html?id=590158'"/>
...
<xsl:variable name="para_nob" select="'kunstavdelingen.html?id=590158'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kunstavdelinga.html_id=590158" xml:lang="nno"/>
	<parallel_text location="kunstavdelingen.html_id=590158" xml:lang="nob"/>
	<parallel_text location="daiddaossodat.html_id=590158" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
