...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-international-cooperation.html?id=1203'"/>
...
<xsl:variable name="para_nob" select="'internasjonalt_samarbeid.html?id=1203'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="internasjonalt_samarbeid.html_id=1203" xml:lang="nob"/>
	<parallel_text location="gaskariikkala-ovttasbargoossodat.html_id=1203" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
