...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/selected-topics/civil--rights.html?id=430375'"/>
...
<xsl:variable name="para_nob" select="'folkerett.html?id=430375'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="folkerett.html_id=430375" xml:lang="nob"/>
	<parallel_text location="folkerett_samisk.html_id=430375" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
