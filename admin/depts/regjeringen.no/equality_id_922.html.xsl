...
<xsl:variable name="filename" select="'http://regjeringen.no/en/topics/Equality.html?id=922'"/>
...
<xsl:variable name="para_nob" select="'likestilling.html?id=922'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="likestilling.html_id=922" xml:lang="nno"/>
	<parallel_text location="likestilling.html_id=922" xml:lang="nob"/>
	<parallel_text location="dassearvu.html_id=922" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
