...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Documents/Legislation.html?id=313564'"/>
...
<xsl:variable name="para_nob" select="'lover_regler.html?id=313564'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lover-og-reglar.html_id=313564" xml:lang="nno"/>
	<parallel_text location="lover_regler.html_id=313564" xml:lang="nob"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
