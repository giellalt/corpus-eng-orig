...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/organisation/departments/the-department-of-integration-and-divers.html?id=589415'"/>
...
<xsl:variable name="para_nob" select="'integrerings--og-mangfoldsavdelingen.html?id=589415'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="integrerings--og-mangfaldsavdelinga.html_id=589415" xml:lang="nno"/>
	<parallel_text location="integrerings--og-mangfoldsavdelingen.html_id=589415" xml:lang="nob"/>
	<parallel_text location="searvadahttin--ja-girjaivuoaossodat-.html_id=589415" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
