...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new/Speeches-and-articles/statsministeren/statsminister_jens_stoltenberg/2013/prime-minister-jens-stoltenbergs-new-yea.html?id=710868'"/>
...
<xsl:variable name="para_nob" select="'statsministerens-nyttarstale-2013.html_id=710868'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statsministerens-nyttarstale-2013.html_id=710868" xml:lang="nob"/>
	<parallel_text location="stahtaministara-jens-stoltenberg-oajagis.html_id=710868" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
