...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/Child-welfare/call-child-welfare.html?id=537079'"/>
...
<xsl:variable name="para_nob" select="'melde-til-barnevernet.html?id=537079'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="melde-til-barnevernet.html_id=537079" xml:lang="nob"/>
	<parallel_text location="dieihit-manaidsuodjalussii.html_id=537079" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
