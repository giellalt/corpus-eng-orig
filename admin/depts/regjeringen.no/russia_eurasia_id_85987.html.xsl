...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/security_policy/russia_eurasia.html?id=85987'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="russland_eurasia.html_id=85987" xml:lang="nob"/>
	<parallel_text location="miehtamailbmasa-sihkkarvuoagaaldagaid-ja-sus-riikkaid-sekuvdna.html_id=85987" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
