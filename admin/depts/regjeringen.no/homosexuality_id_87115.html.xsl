...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Topics/homosexuality.html?id=87115'"/>
...
<xsl:variable name="para_nob" select="'homofile-og-lesbiske.html?id=87115'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="homofile-og-lesbiske.html_id=87115" xml:lang="nob"/>
	<parallel_text location="lesbbat-homofiilat-bifiillat-transsat-.html_id=87115" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
