...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/the-ministry-of-agriculture-and-food/other-political-staff/political-advisor-ane-hansdatter-kismul-.html?id=522309'"/>
...
<xsl:variable name="para_nob" select="'politisk-radgiver-ane-hansdatter-kismul-.html?id=522309'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="politisk-radgiver-ane-hansdatter-kismul-.html_id=522309" xml:lang="nob"/>
	<parallel_text location="politihkala-raeaddi-ane-hansdatter-kismu.html_id=522309" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
