...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/oed/Site-map.html?id=313868'"/>
...
<xsl:variable name="para_nob" select="'nettstedskart.html?id=313868'"/>
