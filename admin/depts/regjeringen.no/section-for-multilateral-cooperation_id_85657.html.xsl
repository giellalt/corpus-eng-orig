...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/About-the-Ministry/organisation/Departments/department-for-international-cooperation/section-for-multilateral-cooperation.html?id=85657'"/>
...
<xsl:variable name="para_nob" select="'multilateralt_samarbeid_miljofora.html?id=85657'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="multilateralt_samarbeid_miljofora.html_id=85657" xml:lang="nob"/>
	<parallel_text location="globala-ovttasbarggu-sekuvdna-.html_id=85657" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
