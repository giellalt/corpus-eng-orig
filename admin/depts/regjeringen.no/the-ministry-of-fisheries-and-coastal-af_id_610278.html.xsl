...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fkd/Whats-new/News/2010/the-ministry-of-fisheries-and-coastal-af.html?id=610278'"/>
...
<xsl:variable name="para_nob" select="'fiskeri--og-kystdepartementet-far-ansvar.html?id=610278'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fiskeri--og-kystdepartementet-far-ansvar.html_id=610278" xml:lang="nob"/>
	<parallel_text location="guolastus--ja-riddodepartemeanta-oau-ovd.html_id=610278" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
