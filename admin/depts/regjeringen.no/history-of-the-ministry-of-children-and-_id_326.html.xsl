...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/BLD-arbeider-for-at/organisation/History-of-the-Ministry-of-Children-and-.html?id=326'"/>
...
<xsl:variable name="para_nob" select="'historikk.html?id=326'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="historia-til-barne--og-likestillingsdepa.html_id=326" xml:lang="nno"/>
	<parallel_text location="historikk.html_id=326" xml:lang="nob"/>
	<parallel_text location="historja.html_id=326" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
