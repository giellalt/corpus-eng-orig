...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/md/documents-and-publications/Circulars.html?id=2011'"/>
...
<xsl:variable name="para_nob" select="'rundskriv.html?id=2011'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rundskriv.html_id=2011" xml:lang="nno"/>
	<parallel_text location="rundskriv.html_id=2011" xml:lang="nob"/>
	<parallel_text location="johtocalus.html_id=2011" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
