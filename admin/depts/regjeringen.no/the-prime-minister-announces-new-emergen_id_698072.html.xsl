...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/press-center/Press-releases/2012/the-prime-minister-announces-new-emergen.html?id=698072'"/>
...
<xsl:variable name="para_nob" select="'beredskapstiltak.html_id=698072'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="beredskapstiltak.html_id=698072" xml:lang="nob"/>
	<parallel_text location="stahtaministtar-almmuha-oa-gearggusvuoad.html_id=698072" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
