...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/bld/Press-Center/Picture-archive.html?id=327'"/>
...
<xsl:variable name="para_nob" select="'bildearkiv.html?id=327'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="biletarkiv.html_id=327" xml:lang="nno"/>
	<parallel_text location="bildearkiv.html_id=327" xml:lang="nob"/>
	<parallel_text location="govvavuorka.html_id=327" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
