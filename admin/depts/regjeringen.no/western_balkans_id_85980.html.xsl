...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/department_european/western_balkans.html?id=85980'"/>
...
<xsl:variable name="para_nob" select="'vest_balkan.html?id=85980'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="vest_balkan.html_id=85980" xml:lang="nob"/>
	<parallel_text location="oarje-balkan-sekuvdna.html_id=85980" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
