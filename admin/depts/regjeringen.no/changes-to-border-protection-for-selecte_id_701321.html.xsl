...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/lmd/press-center/pressemeldinger/2012/changes-to-border-protection-for-selecte.html?id=701321'"/>
...
<xsl:variable name="para_nob" select="'forsterker-importvernet-for-utvalgte-lan.html_id=701321'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forsterker-importvernet-for-utvalgte-lan.html_id=701321" xml:lang="nob"/>
	<parallel_text location="buoret-ja-eanet-eanandoallu-ruaid-ovddas.html_id=701321" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
