...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/organisation/departments/avdeling_for_presse_kultur_og_informasjo/section-for-diplomatic-relations.html?id=87020'"/>
...
<xsl:variable name="para_nob" select="'diplomatseksjonen.html?id=87020'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="diplomatseksjonen.html_id=87020" xml:lang="nob"/>
	<parallel_text location="diplomahtasekuvdna.html_id=87020" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
