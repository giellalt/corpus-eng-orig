...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/fd/press-centre/Press-releases/20141/norway-assumes-nordefco-chairmanship.html?id=748235'"/>
...
<xsl:variable name="para_nob" select="'norge-leder-det-nordiske-forsvarssamarbe.html_id=748235'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="norge-leder-det-nordiske-forsvarssamarbe.html_id=748235" xml:lang="nob"/>
	<parallel_text location="norga-joiha-davviriikkaid-suodjalusovtta.html_id=748235" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
