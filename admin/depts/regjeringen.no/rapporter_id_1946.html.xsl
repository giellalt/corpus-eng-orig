...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/dok/rapporter_planer/rapporter.html?id=1946'"/>
...
<xsl:variable name="para_nob" select="'rapporter_planer.html?id=272527'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rapportar.html_id=1946" xml:lang="nno"/>
	<parallel_text location="rapporter.html_id=1946" xml:lang="nob"/>
	<parallel_text location="raporttat.html_id=1946" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
