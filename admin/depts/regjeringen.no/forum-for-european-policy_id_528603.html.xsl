...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/Subjects/rural-and-regional-policy/international-cooperation-on-rural-and-r/forum-for-european-policy.html?id=528603'"/>
...
<xsl:variable name="para_nob" select="'europapolitisk-forum.html?id=528603'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="europapolitisk-forum.html_id=528603" xml:lang="nob"/>
	<parallel_text location="eurohpapolitihkala-forum--.html_id=528603" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
