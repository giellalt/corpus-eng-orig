...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/study-financing-.html?id=1422'"/>
...
<xsl:variable name="para_nob" select="'utdanningsfinansering.html?id=1422'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="utdanningsfinansering.html_id=1422" xml:lang="nob"/>
	<parallel_text location="oahppodoarjja.html_id=1422" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
