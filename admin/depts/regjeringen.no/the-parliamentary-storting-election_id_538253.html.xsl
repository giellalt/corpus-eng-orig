...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/kampanjer/election_portal/the-parliamentary-storting-election.html?id=538253'"/>
...
<xsl:variable name="para_nob" select="'stortingsvalg.html?id=538253'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stortingsval.html_id=538253" xml:lang="nno"/>
	<parallel_text location="stortingsvalg.html_id=538253" xml:lang="nob"/>
	<parallel_text location="ddd.html_id=538253" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
