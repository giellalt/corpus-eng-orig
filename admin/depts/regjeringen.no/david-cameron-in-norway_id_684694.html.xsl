...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/smk/Whats-new/news/2012/david-cameron-in-norway.html?id=684694'"/>
...
<xsl:variable name="para_nob" select="'david-cameron-i-norge.html_id=684694'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="david-cameron-i-norge.html_id=684694" xml:lang="nob"/>
	<parallel_text location="david-cameron-norggas.html_id=684694" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
