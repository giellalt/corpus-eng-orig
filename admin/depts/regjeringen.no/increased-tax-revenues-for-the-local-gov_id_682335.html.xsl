...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/krd/press/press-releases/2012/increased-tax-revenues-for-the-local-gov.html?id=682335'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Suohkansuorggi vearrodietnasat lassánit 2012:s - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'auka-skatteinntekter-for-kommunesektoren.html_id=682335'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="auka-skatteinntekter-for-kommunesektoren.html_id=682335" xml:lang="nno"/>
	<parallel_text location="god-utvikling-i-norsk-okonomi.html_id=682404" xml:lang="nob"/>
	<parallel_text location="suohkansuorggi-vearrodietnasat-lassanit-.html_id=682335" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
