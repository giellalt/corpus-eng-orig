...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/about_mfa/contact/telephone-list.html?id=272477'"/>
...
<xsl:variable name="wordcount" select="'718'"/>
...
<xsl:variable name="para_nno" select="'telefonliste.html?id=272477'"/>
<xsl:variable name="para_nob" select="'telefonliste.html?id=272477'"/>
