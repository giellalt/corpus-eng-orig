...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/ud/selected-topics/human-rights/menneskerettigheter-urfolk/indigenous-peoples-in-development-cooper.html?id=447051'"/>
...
<xsl:variable name="para_nob" select="'urfolk-i-utviklingsarbeidet.html?id=447051'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="urfolk-i-utviklingsarbeidet.html_id=447051" xml:lang="nob"/>
	<parallel_text location="utvpol_samisk.html_id=447051" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
