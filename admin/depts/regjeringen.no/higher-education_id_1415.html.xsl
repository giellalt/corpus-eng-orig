...
<xsl:variable name="filename" select="'http://regjeringen.no/en/dep/kd/Selected-topics/Higher-Education.html?id=1415'"/>
...
<xsl:variable name="para_nob" select="'hoyere_utdanning.html?id=1415'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hoyere_utdanning.html_id=1415" xml:lang="nob"/>
	<parallel_text location="alit-oahppu.html_id=1415" xml:lang="sme"/>
</xsl:variable>
>>>>>>> 6cec71f8fa (English regjeringen.no doc renamed, metadata updated in parallel files)
