...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.udir.no/globalassets/filer/kvalitet-og-kompetanse/korona/forelderinfo_engelsk.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Information to parents of kindergarten children'"/>
    <!--
    ...
    <xsl:variable name="bottom_margin" select="'1=2'"/>
