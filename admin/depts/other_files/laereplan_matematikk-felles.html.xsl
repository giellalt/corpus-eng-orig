...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/kl06/MAT1-04/Hele/Komplett_visning?lplang=eng&amp;read=1'"/>
	...
	<parallel_text xml:lang="smj" location="laereplan_matematikk-felles.html"/></xsl:variable>
