...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/Upload/larerplaner/Fastsatte_lareplaner_for_Kunnskapsloeftet/english/5/Subject_curriculum_in_sami_as_the_first_language_sami_1.doc'"/>
