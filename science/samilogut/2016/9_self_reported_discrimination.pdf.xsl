...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/9_self.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Self-Reported Experience of Discrimination against Samis in Norway'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="7_selvopplevd_diskriminering.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'8, 13, 16, 22-24'"/>
    ...
    <xsl:variable name="top_margin" select="'5=72, 9=25, 19=50'"/>
    <xsl:variable name="bottom_margin" select="'11=87, 18=73'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'20=7'"/>
    <xsl:variable name="inner_left_margin" select="'20=7'"/>
    <xsl:variable name="inner_top_margin" select="'20=21'"/>
    <xsl:variable name="inner_bottom_margin" select="'20=21'"/>
