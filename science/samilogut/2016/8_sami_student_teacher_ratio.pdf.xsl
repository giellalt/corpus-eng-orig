...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/8_sami_student.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sami Student-Teacher Ratio'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="5_samisk_laerertetthet.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'11, 14-15'"/>
    ...
    <xsl:variable name="top_margin" select="'12=48, 16=22'"/>
    <xsl:variable name="bottom_margin" select="'5=67, 7=25, 10=81, 13=18, 16=16, 17=18, 18=22, 20=78'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'3=7, 6=7, 8=7, 9=7'"/>
    <xsl:variable name="inner_left_margin" select="'3=7, 6=7, 8=7, 9=7'"/>
    <xsl:variable name="inner_top_margin" select="'3=16, 6=78, 8=34, 9=15'"/>
    <xsl:variable name="inner_bottom_margin" select="'3=75, 6=13, 8=30, 9=50'"/>
