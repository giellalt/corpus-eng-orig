...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-6, 9, 12-13, 16-216'"/>
    ...
    <xsl:variable name="top_margin" select="'7=54, 10=25, 14=23'"/>
    <xsl:variable name="bottom_margin" select="'8=85, 11=35, 15=55, all=10'"/>
