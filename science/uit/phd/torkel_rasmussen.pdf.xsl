...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'orig/sme/science/uit/phd/torkel_rasmussen.pdf'"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-6, 10-334'"/>
    ...
    <xsl:variable name="top_margin" select="'7=23'"/>
    <xsl:variable name="bottom_margin" select="'7=16, all=10'"/>
