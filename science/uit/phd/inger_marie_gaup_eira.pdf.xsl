...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'orig/sme/science/uit/phd/inger_marie_gaup_eira.pdf'"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-6, 8, 10-86, 163-204'"/>
    ...
    <xsl:variable name="top_margin" select="'7=40'"/>
