...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://oahpa.no/sme/usevisl/Syntris_eng.html'"/>
    ...
    <parallel_text location="syntris_sme.html" xml:lang="sme"/>
<parallel_text location="syntris_nob.html" xml:lang="nno"/>
</xsl:variable>
