...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <language xml:lang="nob"/><language xml:lang="sms"/><language xml:lang="rus"/><language xml:lang="eng"/><language xml:lang="fin"/></xsl:variable>
    ...
    <xsl:variable name="bottom_margin" select="'2=70, 3=50'"/>
