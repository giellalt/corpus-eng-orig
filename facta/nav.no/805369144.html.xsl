...
<xsl:variable name="filename" select="'http://www.nav.no/English/Stay+in+Norway/805369144.cms'"/>
...
<xsl:variable name="wordcount" select="'1603'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="foreldrepenger_ved_adopsjon.html" xml:lang="nob"/>
