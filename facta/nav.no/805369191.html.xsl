...
<xsl:variable name="filename" select="'http://www.nav.no/Familie/Enslig+mor+eller+far/Enslig+mor+eller+far/805369191.cms'"/>
...
<xsl:variable name="wordcount" select="'764'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="oversikt_over_stonader_og_vilkar.html" xml:lang="nob"/>
