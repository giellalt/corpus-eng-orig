...
<xsl:variable name="filename" select="'http://www.nav.no/English/Stay+in+Norway/805369034.cms'"/>
...
<xsl:variable name="wordcount" select="'1610'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="foreldrepenger_ved_fodsel.html" xml:lang="nob"/>
