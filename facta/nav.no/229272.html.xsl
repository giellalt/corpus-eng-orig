...
<xsl:variable name="filename" select="'http://www.nav.no/English/Stay+in+Norway/229272.cms'"/>
...
<xsl:variable name="wordcount" select="'3217'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="foreldrepenger_til_far_ved_fodsel_og_adopsjon.html" xml:lang="nob"/>
