...
<xsl:variable name="filename" select="'http://www.nav.no/English/Stay+in+Norway/805368912.cms'"/>
...
<xsl:variable name="wordcount" select="'1158'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="bidragsforskudd.html" xml:lang="nob"/>
