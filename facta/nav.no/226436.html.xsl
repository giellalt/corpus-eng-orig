...
<xsl:variable name="filename" select="'http://www.nav.no/English/Social+security/226436.cms'"/>
...
<xsl:variable name="wordcount" select="'1117'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="lonnsgaranti.html" xml:lang="nob"/>
