...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://site.uit.no/smartstien/files/2012/06/hefte_engelsk_test.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'The story of Margrete Kreutz'"/>
    <!--
    ...
    <xsl:variable name="translator_fn" select="'Isak'"/>
    <xsl:variable name="translator_ln" select="'Måseide'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="margrete_kreutz_historie.pdf"/>
