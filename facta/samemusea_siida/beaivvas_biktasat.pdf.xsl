...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-2, 4, 6, 9, 13, 15, 16, 19, 20, 26, 29, 33-35, 37-43, 45-47, 49-53, 55-60'"/>
    ...
    <xsl:variable name="left_margin" select="'all=65, 5=50, 8;10;12;14;18;22;24;28;30=60'"/>
