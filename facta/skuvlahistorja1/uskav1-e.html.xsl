...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/uskav1-e.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sami without education: A 20 year struggle'"/>
    <!--
    ...
    <xsl:variable name="translator_fn" select="'Simon'"/>
    <xsl:variable name="translator_ln" select="'Aldridge'"/>
    <xsl:variable name="translator_gender" select="'m'"/>
    <xsl:variable name="translator_born" select="''"/>
    <xsl:variable name="translator_nat" select="'UK'"/>
    ...
    <xsl:variable name="wordcount" select="'8935'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nob" location="uskav1-n.html"/>
