...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/uskav2-e.htm'"/>
<xsl:variable name="title" select="'Three lives with a lost education'"/>
...
<xsl:variable name="wordcount" select="'2307'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="uskav2-n.html" xml:lang="nob"/>
