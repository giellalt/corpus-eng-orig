...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/josefsen-e.htm'"/>
...
<xsl:variable name="wordcount" select="'4017'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="josefsen-n.html" xml:lang="nno"/>
</xsl:variable>
