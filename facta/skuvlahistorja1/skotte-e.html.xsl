...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/skotte-e.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="''"/>
<xsl:variable name="author1_fn" select="'Ivar'"/>
<xsl:variable name="author1_ln" select="'Skotte'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skotte-n.html" xml:lang="nno"/>
	<parallel_text location="skotte_s.html" xml:lang="sme"/>
</xsl:variable>
