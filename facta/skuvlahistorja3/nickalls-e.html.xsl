...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/nickalls-e.htm'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Chris'"/>
    <xsl:variable name="author1_ln" select="'Nickalls'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="wordcount" select="'1075'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="nno" location="nickalls-n.html"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="nickalls-s.html"/>
